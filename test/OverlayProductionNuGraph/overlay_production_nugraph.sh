...
for fcl in \
  wirecell_reg4_LightPropTime_LY.fcl \
  wirecell_detsim_optical_overlay_uboone.fcl \
  standard_overlay_notpc_uboone.fcl \
  reco_uboone_mcc9_8_driver_overlay_optical.fcl \
  reco_uboone_mcc9_10_driver_overlay_stage2a.fcl \
  reco_uboone_mcc9_10_driver_overlay_nugraph.fcl \
  reco_uboone_mcc9_10_driver_overlay_stage2b.fcl \
  run_fullshowerreco_overlay.fcl \
  run_reboone.fcl
do
