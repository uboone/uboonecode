...
namespace larreco
{
  ...
  public:
    ...
    std::vector<float> vtxDaughter;            ///< Daughters' closest vtx to the shower vtx
  ...
  public:
    ...
    /*
    std::vector<double> ChargeFraction(art::Ptr<recob::Cluster> cluster_ptr,
				       art::PtrVector<recob::Hit> hits_ptr) const;
    */
