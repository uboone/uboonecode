...
void plot_com_MCaddOffbeam_sigsep(){
  gROOT->SetBatch();
  //loadStyle();
  int tune = 1;
  ...
  TFile *input2;
  if (tune==3){
    input2 = new TFile("histAnalysis_Tune3_wCosmicCut.root");  
  }
  else{
    input2 = new TFile("histAnalysis_MC_wCosmicCut.root");  
  }
...
*/
  ...
  h_ntrksp_sig[1]=(TH1D*)input2->Get("ntrks_proton_sig_0");
  h_ntrksp_sig[1]->Sumw2();

  h_ntrksp_sig[2]=(TH1D*)input2->Get("ntrks_proton_sig_1");
  h_ntrksp_sig[2]->Sumw2();  

  h_ntrksp_sig[3]=(TH1D*)input2->Get("ntrks_proton_sig_2");
  h_ntrksp_sig[3]->Sumw2();

  h_ntrksp_sig[4]=(TH1D*)input2->Get("ntrks_proton_sig_3");
  h_ntrksp_sig[4]->Sumw2();
  ...
  h_Evis_sig[1]=(TH1D*)input2->Get("fEvis_all_sig_0");
  h_Evis_sig[1]->Rebin(4);
  h_Evis_sig[1]->Sumw2();

  h_Evis_sig[2]=(TH1D*)input2->Get("fEvis_all_sig_1");
  h_Evis_sig[2]->Rebin(4);
  h_Evis_sig[2]->Sumw2();

  h_Evis_sig[3]=(TH1D*)input2->Get("fEvis_all_sig_2");
  h_Evis_sig[3]->Rebin(4);
  h_Evis_sig[3]->Sumw2();

  h_Evis_sig[4]=(TH1D*)input2->Get("fEvis_all_sig_3");
  h_Evis_sig[4]->Rebin(4);
  h_Evis_sig[4]->Sumw2();
  ...
  h_Q2cal_sig[1]=(TH1D*)input2->Get("fQ2cal_all_sig_0");
  h_Q2cal_sig[1]->Rebin(4);
  h_Q2cal_sig[1]->Sumw2();

  h_Q2cal_sig[2]=(TH1D*)input2->Get("fQ2cal_all_sig_1");
  h_Q2cal_sig[2]->Rebin(4);
  h_Q2cal_sig[2]->Sumw2();

  h_Q2cal_sig[3]=(TH1D*)input2->Get("fQ2cal_all_sig_2");
  h_Q2cal_sig[3]->Rebin(4);
  h_Q2cal_sig[3]->Sumw2();

  h_Q2cal_sig[4]=(TH1D*)input2->Get("fQ2cal_all_sig_3");
  h_Q2cal_sig[4]->Rebin(4);
  h_Q2cal_sig[4]->Sumw2();
  ...
  h_range_sig[1]=(TH1D*)input2->Get("trklen_muon_sig_0");
  h_range_sig[1]->Rebin(4);
  h_range_sig[1]->Sumw2();

  h_range_sig[2]=(TH1D*)input2->Get("trklen_muon_sig_1");
  h_range_sig[2]->Rebin(4);
  h_range_sig[2]->Sumw2();

  h_range_sig[3]=(TH1D*)input2->Get("trklen_muon_sig_2");
  h_range_sig[3]->Rebin(4);
  h_range_sig[3]->Sumw2();

  h_range_sig[4]=(TH1D*)input2->Get("trklen_muon_sig_3");
  h_range_sig[4]->Rebin(4);
  h_range_sig[4]->Sumw2();
  ...
  h_trkmom_sig[1]=(TH1D*)input2->Get("trkmom_muon_sig_0");
  h_trkmom_sig[1]->Rebin(4);
  h_trkmom_sig[1]->Sumw2();

  h_trkmom_sig[2]=(TH1D*)input2->Get("trkmom_muon_sig_1");
  h_trkmom_sig[2]->Rebin(4);
  h_trkmom_sig[2]->Sumw2();

  h_trkmom_sig[3]=(TH1D*)input2->Get("trkmom_muon_sig_2");
  h_trkmom_sig[3]->Rebin(4);
  h_trkmom_sig[3]->Sumw2();

  h_trkmom_sig[4]=(TH1D*)input2->Get("trkmom_muon_sig_3");
  h_trkmom_sig[4]->Rebin(4);
  h_trkmom_sig[4]->Sumw2();
  ...
  h_phi_sig[1]=(TH1D*)input2->Get("phi_muon_sig_0");
  h_phi_sig[1]->Rebin(4);
  h_phi_sig[1]->Sumw2();

  h_phi_sig[2]=(TH1D*)input2->Get("phi_muon_sig_1");
  h_phi_sig[2]->Rebin(4);
  h_phi_sig[2]->Sumw2();

  h_phi_sig[3]=(TH1D*)input2->Get("phi_muon_sig_2");
  h_phi_sig[3]->Rebin(4);
  h_phi_sig[3]->Sumw2();

  h_phi_sig[4]=(TH1D*)input2->Get("phi_muon_sig_3");
  h_phi_sig[4]->Rebin(4);
  h_phi_sig[4]->Sumw2();
  ...
  h_pphi_sig[1]=(TH1D*)input2->Get("phi_proton_sig_0");
  h_pphi_sig[1]->Rebin(4);
  h_pphi_sig[1]->Sumw2();

  h_pphi_sig[2]=(TH1D*)input2->Get("phi_proton_sig_1");
  h_pphi_sig[2]->Rebin(4);
  h_pphi_sig[2]->Sumw2();

  h_pphi_sig[3]=(TH1D*)input2->Get("phi_proton_sig_2");
  h_pphi_sig[3]->Rebin(4);
  h_pphi_sig[3]->Sumw2();

  h_pphi_sig[4]=(TH1D*)input2->Get("phi_proton_sig_3");
  h_pphi_sig[4]->Rebin(4);
  h_pphi_sig[4]->Sumw2();
  ...
  TH1D               *h_costheta_sig[8];
  TH1D               *h_costheta_bac[8];
  h_costheta_sig[0]=(TH1D*)input2->Get("costheta_muon_0");
  h_costheta_sig[0]->Rebin(5);
  h_costheta_sig[0]->Sumw2();

  h_costheta_sig[1]=(TH1D*)input2->Get("costheta_muon_sig_0");
  h_costheta_sig[1]->Rebin(5);
  h_costheta_sig[1]->Sumw2();

  h_costheta_sig[2]=(TH1D*)input2->Get("costheta_muon_sig_1");
  h_costheta_sig[2]->Rebin(5);
  h_costheta_sig[2]->Sumw2();

  h_costheta_sig[3]=(TH1D*)input2->Get("costheta_muon_sig_2");
  h_costheta_sig[3]->Rebin(5);
  h_costheta_sig[3]->Sumw2();

  h_costheta_sig[4]=(TH1D*)input2->Get("costheta_muon_sig_3");
  h_costheta_sig[4]->Rebin(5);
  h_costheta_sig[4]->Sumw2();
  ...
  h_pcostheta_sig[1]=(TH1D*)input2->Get("costheta_proton_sig_0");
  h_pcostheta_sig[1]->Rebin(5);
  h_pcostheta_sig[1]->Sumw2();

  h_pcostheta_sig[2]=(TH1D*)input2->Get("costheta_proton_sig_1");
  h_pcostheta_sig[2]->Rebin(5);
  h_pcostheta_sig[2]->Sumw2();

  h_pcostheta_sig[3]=(TH1D*)input2->Get("costheta_proton_sig_2");
  h_pcostheta_sig[3]->Rebin(5);
  h_pcostheta_sig[3]->Sumw2();

  h_pcostheta_sig[4]=(TH1D*)input2->Get("costheta_proton_sig_3");
  h_pcostheta_sig[4]->Rebin(5);
  h_pcostheta_sig[4]->Sumw2();
  ...
  h_trunmean_muon_sig[1]=(TH1D*)input2->Get("trunmean_muon_sig_0");
  h_trunmean_muon_sig[1]->Rebin(5);
  h_trunmean_muon_sig[1]->Sumw2();

  h_trunmean_muon_sig[2]=(TH1D*)input2->Get("trunmean_muon_sig_1");
  h_trunmean_muon_sig[2]->Rebin(5);
  h_trunmean_muon_sig[2]->Sumw2();

  h_trunmean_muon_sig[3]=(TH1D*)input2->Get("trunmean_muon_sig_2");
  h_trunmean_muon_sig[3]->Rebin(5);
  h_trunmean_muon_sig[3]->Sumw2();

  h_trunmean_muon_sig[4]=(TH1D*)input2->Get("trunmean_muon_sig_3");
  h_trunmean_muon_sig[4]->Rebin(5);
  h_trunmean_muon_sig[4]->Sumw2();
  ...
  h_trunmean_proton_sig[1]=(TH1D*)input2->Get("trunmean_proton_sig_0");
  h_trunmean_proton_sig[1]->Rebin(5);
  h_trunmean_proton_sig[1]->Sumw2();

  h_trunmean_proton_sig[2]=(TH1D*)input2->Get("trunmean_proton_sig_1");
  h_trunmean_proton_sig[2]->Rebin(5);
  h_trunmean_proton_sig[2]->Sumw2();

  h_trunmean_proton_sig[3]=(TH1D*)input2->Get("trunmean_proton_sig_2");
  h_trunmean_proton_sig[3]->Rebin(5);
  h_trunmean_proton_sig[3]->Sumw2();

  h_trunmean_proton_sig[4]=(TH1D*)input2->Get("trunmean_proton_sig_3");
  h_trunmean_proton_sig[4]->Rebin(5);
  h_trunmean_proton_sig[4]->Sumw2();
  ...
  h_plep_sig[1]=(TH1D*)input2->Get("fPmuon_sig_0");
  h_plep_sig[1]->Rebin(5);
  h_plep_sig[1]->Sumw2();

  h_plep_sig[2]=(TH1D*)input2->Get("fPmuon_sig_1");
  h_plep_sig[2]->Rebin(5);
  h_plep_sig[2]->Sumw2();

  h_plep_sig[3]=(TH1D*)input2->Get("fPmuon_sig_2");
  h_plep_sig[3]->Rebin(5);
  h_plep_sig[3]->Sumw2();

  h_plep_sig[4]=(TH1D*)input2->Get("fPmuon_sig_3");
  h_plep_sig[4]->Rebin(5);
  h_plep_sig[4]->Sumw2();
  ...
  TH1D               *h_thetamup_sig[8];
  TH1D               *h_thetamup_bac[8];
  h_thetamup_sig[0]=(TH1D*)input2->Get("h_thetamup_0");
  h_thetamup_sig[0]->Rebin(4);
  h_thetamup_sig[0]->Sumw2();

  h_thetamup_sig[1]=(TH1D*)input2->Get("h_thetamup_sig_0");
  h_thetamup_sig[1]->Rebin(4);
  h_thetamup_sig[1]->Sumw2();

  h_thetamup_sig[2]=(TH1D*)input2->Get("h_thetamup_sig_1");
  h_thetamup_sig[2]->Rebin(4);
  h_thetamup_sig[2]->Sumw2();

  h_thetamup_sig[3]=(TH1D*)input2->Get("h_thetamup_sig_2");
  h_thetamup_sig[3]->Rebin(4);
  h_thetamup_sig[3]->Sumw2();

  h_thetamup_sig[4]=(TH1D*)input2->Get("h_thetamup_sig_3");
  h_thetamup_sig[4]->Rebin(4);
  h_thetamup_sig[4]->Sumw2();
  ...
  TH1D               *h_thetapp_sig[8];
  TH1D               *h_thetapp_bac[8];
  h_thetapp_sig[0]=(TH1D*)input2->Get("h_thetapp_0");
  h_thetapp_sig[0]->Rebin(4);
  h_thetapp_sig[0]->Sumw2();
  h_thetapp_sig[1]=(TH1D*)input2->Get("h_thetapp_sig_0");
  h_thetapp_sig[1]->Rebin(4);
  h_thetapp_sig[1]->Sumw2();
  h_thetapp_sig[2]=(TH1D*)input2->Get("h_thetapp_sig_1");
  h_thetapp_sig[2]->Rebin(4);
  h_thetapp_sig[2]->Sumw2();
  h_thetapp_sig[3]=(TH1D*)input2->Get("h_thetapp_sig_2");
  h_thetapp_sig[3]->Rebin(4);
  h_thetapp_sig[3]->Sumw2();
  h_thetapp_sig[4]=(TH1D*)input2->Get("h_thetapp_sig_3");
  h_thetapp_sig[4]->Rebin(4);
  h_thetapp_sig[4]->Sumw2();
  ...
  h_phimup_sig[1]=(TH1D*)input2->Get("h_phimup_sig_0");
  h_phimup_sig[1]->Rebin(4);
  h_phimup_sig[1]->Sumw2();
  h_phimup_sig[2]=(TH1D*)input2->Get("h_phimup_sig_1");
  h_phimup_sig[2]->Rebin(4);
  h_phimup_sig[2]->Sumw2();
  h_phimup_sig[3]=(TH1D*)input2->Get("h_phimup_sig_2");
  h_phimup_sig[3]->Rebin(4);
  h_phimup_sig[3]->Sumw2();
  h_phimup_sig[4]=(TH1D*)input2->Get("h_phimup_sig_3");
  h_phimup_sig[4]->Rebin(4);
  h_phimup_sig[4]->Sumw2();
  ...
  h_phipp_sig[0]->Sumw2();
  h_phipp_sig[1]=(TH1D*)input2->Get("h_phipp_sig_0");
  h_phipp_sig[1]->Rebin(4);
  h_phipp_sig[1]->Sumw2();
  h_phipp_sig[2]=(TH1D*)input2->Get("h_phipp_sig_1");
  h_phipp_sig[2]->Rebin(4);
  h_phipp_sig[2]->Sumw2();
  h_phipp_sig[3]=(TH1D*)input2->Get("h_phipp_sig_2");
  h_phipp_sig[3]->Rebin(4);
  h_phipp_sig[3]->Sumw2();
  h_phipp_sig[4]=(TH1D*)input2->Get("h_phipp_sig_3");
  h_phipp_sig[4]->Rebin(4);
  h_phipp_sig[4]->Sumw2();
  ...
  TH1D               *h_Nhitsmuon_sig[8];
  TH1D               *h_Nhitsmuon_bac[8];
  h_Nhitsmuon_sig[0]=(TH1D*)input2->Get("Nhitsmuon_0");
  h_Nhitsmuon_sig[0]->Rebin(4);
  h_Nhitsmuon_sig[0]->Sumw2();

  h_Nhitsmuon_sig[1]=(TH1D*)input2->Get("Nhitsmuon_sig_0");
  h_Nhitsmuon_sig[1]->Rebin(4);
  h_Nhitsmuon_sig[1]->Sumw2();
  h_Nhitsmuon_sig[2]=(TH1D*)input2->Get("Nhitsmuon_sig_1");
  h_Nhitsmuon_sig[2]->Rebin(4);
  h_Nhitsmuon_sig[2]->Sumw2();
  h_Nhitsmuon_sig[3]=(TH1D*)input2->Get("Nhitsmuon_sig_2");
  h_Nhitsmuon_sig[3]->Rebin(4);
  h_Nhitsmuon_sig[3]->Sumw2();
  h_Nhitsmuon_sig[4]=(TH1D*)input2->Get("Nhitsmuon_sig_3");
  h_Nhitsmuon_sig[4]->Rebin(4);
  h_Nhitsmuon_sig[4]->Sumw2();
  ...
  h_Nhitsproton_sig[1]=(TH1D*)input2->Get("Nhitsproton_sig_0");
  h_Nhitsproton_sig[1]->Rebin(4);
  h_Nhitsproton_sig[1]->Sumw2();
  h_Nhitsproton_sig[2]=(TH1D*)input2->Get("Nhitsproton_sig_1");
  h_Nhitsproton_sig[2]->Rebin(4);
  h_Nhitsproton_sig[2]->Sumw2();
  h_Nhitsproton_sig[3]=(TH1D*)input2->Get("Nhitsproton_sig_2");
  h_Nhitsproton_sig[3]->Rebin(4);
  h_Nhitsproton_sig[3]->Sumw2();
  h_Nhitsproton_sig[4]=(TH1D*)input2->Get("Nhitsproton_sig_3");
  h_Nhitsproton_sig[4]->Rebin(4);
  h_Nhitsproton_sig[4]->Sumw2();
  ...
  h_vtxx_sig[1]=(TH1D*)input2->Get("fvertexx_sig_0");
  h_vtxx_sig[1]->Rebin(4);
  h_vtxx_sig[1]->Sumw2();
  h_vtxx_sig[2]=(TH1D*)input2->Get("fvertexx_sig_1");
  h_vtxx_sig[2]->Rebin(4);
  h_vtxx_sig[2]->Sumw2();
  h_vtxx_sig[3]=(TH1D*)input2->Get("fvertexx_sig_2");
  h_vtxx_sig[3]->Rebin(4);
  h_vtxx_sig[3]->Sumw2();
  h_vtxx_sig[4]=(TH1D*)input2->Get("fvertexx_sig_3");
  h_vtxx_sig[4]->Rebin(4);
  h_vtxx_sig[4]->Sumw2();
  ...
  h_vtxy_sig[1]=(TH1D*)input2->Get("fvertexy_sig_0");
  h_vtxy_sig[1]->Rebin(4);
  h_vtxy_sig[1]->Sumw2();

  h_vtxy_sig[2]=(TH1D*)input2->Get("fvertexy_sig_1");
  h_vtxy_sig[2]->Rebin(4);
  h_vtxy_sig[2]->Sumw2();

  h_vtxy_sig[3]=(TH1D*)input2->Get("fvertexy_sig_2");
  h_vtxy_sig[3]->Rebin(4);
  h_vtxy_sig[3]->Sumw2();

  h_vtxy_sig[4]=(TH1D*)input2->Get("fvertexy_sig_3");
  h_vtxy_sig[4]->Rebin(4);
  h_vtxy_sig[4]->Sumw2();
  ...
  h_vtxz_sig[1]=(TH1D*)input2->Get("fvertexz_sig_0");
  h_vtxz_sig[1]->Rebin(4);
  h_vtxz_sig[1]->Sumw2();

  h_vtxz_sig[2]=(TH1D*)input2->Get("fvertexz_sig_1");
  h_vtxz_sig[2]->Rebin(4);
  h_vtxz_sig[2]->Sumw2();

  h_vtxz_sig[3]=(TH1D*)input2->Get("fvertexz_sig_2");
  h_vtxz_sig[3]->Rebin(4);
  h_vtxz_sig[3]->Sumw2();

  h_vtxz_sig[4]=(TH1D*)input2->Get("fvertexz_sig_3");
  h_vtxz_sig[4]->Rebin(4);
  h_vtxz_sig[4]->Sumw2();
  ...
  TH1D               *h_mustartx_sig[8];
  TH1D               *h_mustartx_bac[8];
  h_mustartx_sig[0]=(TH1D*)input2->Get("fmucandstartx_0");
  h_mustartx_sig[0]->Rebin(4);
  h_mustartx_sig[0]->Sumw2();

  h_mustartx_sig[1]=(TH1D*)input2->Get("fmucandstartx_sig_0");
  h_mustartx_sig[1]->Rebin(4);
  h_mustartx_sig[1]->Sumw2();
  h_mustartx_sig[2]=(TH1D*)input2->Get("fmucandstartx_sig_1");
  h_mustartx_sig[2]->Rebin(4);
  h_mustartx_sig[2]->Sumw2();
  h_mustartx_sig[3]=(TH1D*)input2->Get("fmucandstartx_sig_2");
  h_mustartx_sig[3]->Rebin(4);
  h_mustartx_sig[3]->Sumw2();
  h_mustartx_sig[4]=(TH1D*)input2->Get("fmucandstartx_sig_3");
  h_mustartx_sig[4]->Rebin(4);
  h_mustartx_sig[4]->Sumw2();
  ...
  TH1D               *h_mustarty_sig[8];
  TH1D               *h_mustarty_bac[8];
  h_mustarty_sig[0]=(TH1D*)input2->Get("fmucandstarty_0");
  h_mustarty_sig[0]->Rebin(4);
  h_mustarty_sig[0]->Sumw2();

  h_mustarty_sig[1]=(TH1D*)input2->Get("fmucandstarty_sig_0");
  h_mustarty_sig[1]->Rebin(4);
  h_mustarty_sig[1]->Sumw2();
  h_mustarty_sig[2]=(TH1D*)input2->Get("fmucandstarty_sig_1");
  h_mustarty_sig[2]->Rebin(4);
  h_mustarty_sig[2]->Sumw2();
  h_mustarty_sig[3]=(TH1D*)input2->Get("fmucandstarty_sig_2");
  h_mustarty_sig[3]->Rebin(4);
  h_mustarty_sig[3]->Sumw2();
  h_mustarty_sig[4]=(TH1D*)input2->Get("fmucandstarty_sig_3");
  h_mustarty_sig[4]->Rebin(4);
  h_mustarty_sig[4]->Sumw2();
  ...
  TH1D               *h_mustartz_sig[8];
  TH1D               *h_mustartz_bac[8];
  h_mustartz_sig[0]=(TH1D*)input2->Get("fmucandstartz_0");
  h_mustartz_sig[0]->Rebin(4);
  h_mustartz_sig[0]->Sumw2();
  h_mustartz_sig[1]=(TH1D*)input2->Get("fmucandstartz_sig_0");
  h_mustartz_sig[1]->Rebin(4);
  h_mustartz_sig[1]->Sumw2();
  h_mustartz_sig[2]=(TH1D*)input2->Get("fmucandstartz_sig_1");
  h_mustartz_sig[2]->Rebin(4);
  h_mustartz_sig[2]->Sumw2();
  h_mustartz_sig[3]=(TH1D*)input2->Get("fmucandstartz_sig_2");
  h_mustartz_sig[3]->Rebin(4);
  h_mustartz_sig[3]->Sumw2();
  h_mustartz_sig[4]=(TH1D*)input2->Get("fmucandstartz_sig_3");
  h_mustartz_sig[4]->Rebin(4);
  h_mustartz_sig[4]->Sumw2();
  ...
  h_muendx_sig[1]=(TH1D*)input2->Get("fmucandendx_sig_0");
  h_muendx_sig[1]->Rebin(4);
  h_muendx_sig[1]->Sumw2();
  h_muendx_sig[2]=(TH1D*)input2->Get("fmucandendx_sig_1");
  h_muendx_sig[2]->Rebin(4);
  h_muendx_sig[2]->Sumw2();
  h_muendx_sig[3]=(TH1D*)input2->Get("fmucandendx_sig_2");
  h_muendx_sig[3]->Rebin(4);
  h_muendx_sig[3]->Sumw2();
  h_muendx_sig[4]=(TH1D*)input2->Get("fmucandendx_sig_3");
  h_muendx_sig[4]->Rebin(4);
  h_muendx_sig[4]->Sumw2();
  ...
  h_muendy_sig[1]=(TH1D*)input2->Get("fmucandendy_sig_0");
  h_muendy_sig[1]->Rebin(4);
  h_muendy_sig[1]->Sumw2();
  h_muendy_sig[2]=(TH1D*)input2->Get("fmucandendy_sig_1");
  h_muendy_sig[2]->Rebin(4);
  h_muendy_sig[2]->Sumw2();
  h_muendy_sig[3]=(TH1D*)input2->Get("fmucandendy_sig_2");
  h_muendy_sig[3]->Rebin(4);
  h_muendy_sig[3]->Sumw2();
  h_muendy_sig[4]=(TH1D*)input2->Get("fmucandendy_sig_3");
  h_muendy_sig[4]->Rebin(4);
  h_muendy_sig[4]->Sumw2();
  ...
  h_muendz_sig[1]=(TH1D*)input2->Get("fmucandendz_sig_0");
  h_muendz_sig[1]->Rebin(4);
  h_muendz_sig[1]->Sumw2();
  h_muendz_sig[2]=(TH1D*)input2->Get("fmucandendz_sig_1");
  h_muendz_sig[2]->Rebin(4);
  h_muendz_sig[2]->Sumw2();
  h_muendz_sig[3]=(TH1D*)input2->Get("fmucandendz_sig_2");
  h_muendz_sig[3]->Rebin(4);
  h_muendz_sig[3]->Sumw2();
  h_muendz_sig[4]=(TH1D*)input2->Get("fmucandendz_sig_3");
  h_muendz_sig[4]->Rebin(4);
  h_muendz_sig[4]->Sumw2();
  ...
  TH1D               *h_pstartx_sig[8];
  TH1D               *h_pstartx_bac[8];
  h_pstartx_sig[0]=(TH1D*)input2->Get("fpcandstartx_0");
  h_pstartx_sig[0]->Rebin(4);
  h_pstartx_sig[0]->Sumw2();

  h_pstartx_sig[1]=(TH1D*)input2->Get("fpcandstartx_sig_0");
  h_pstartx_sig[1]->Rebin(4);
  h_pstartx_sig[1]->Sumw2();
  h_pstartx_sig[2]=(TH1D*)input2->Get("fpcandstartx_sig_1");
  h_pstartx_sig[2]->Rebin(4);
  h_pstartx_sig[2]->Sumw2();
  h_pstartx_sig[3]=(TH1D*)input2->Get("fpcandstartx_sig_2");
  h_pstartx_sig[3]->Rebin(4);
  h_pstartx_sig[3]->Sumw2();
  h_pstartx_sig[4]=(TH1D*)input2->Get("fpcandstartx_sig_3");
  h_pstartx_sig[4]->Rebin(4);
  h_pstartx_sig[4]->Sumw2();
  ...
  TH1D               *h_pstarty_sig[8];
  TH1D               *h_pstarty_bac[8];
  h_pstarty_sig[0]=(TH1D*)input2->Get("fpcandstarty_0");
  h_pstarty_sig[0]->Rebin(4);
  h_pstarty_sig[0]->Sumw2();
  h_pstarty_sig[1]=(TH1D*)input2->Get("fpcandstarty_sig_0");
  h_pstarty_sig[1]->Rebin(4);
  h_pstarty_sig[1]->Sumw2();
  h_pstarty_sig[2]=(TH1D*)input2->Get("fpcandstarty_sig_1");
  h_pstarty_sig[2]->Rebin(4);
  h_pstarty_sig[2]->Sumw2();
  h_pstarty_sig[3]=(TH1D*)input2->Get("fpcandstarty_sig_2");
  h_pstarty_sig[3]->Rebin(4);
  h_pstarty_sig[3]->Sumw2();
  h_pstarty_sig[4]=(TH1D*)input2->Get("fpcandstarty_sig_3");
  h_pstarty_sig[4]->Rebin(4);
  h_pstarty_sig[4]->Sumw2();
  ...
  TH1D               *h_pstartz_sig[8];
  TH1D               *h_pstartz_bac[8];
  h_pstartz_sig[0]=(TH1D*)input2->Get("fpcandstartz_0");
  h_pstartz_sig[0]->Rebin(4);
  h_pstartz_sig[0]->Sumw2();
  h_pstartz_sig[1]=(TH1D*)input2->Get("fpcandstartz_sig_0");
  h_pstartz_sig[1]->Rebin(4);
  h_pstartz_sig[1]->Sumw2();
  h_pstartz_sig[2]=(TH1D*)input2->Get("fpcandstartz_sig_1");
  h_pstartz_sig[2]->Rebin(4);
  h_pstartz_sig[2]->Sumw2();
  h_pstartz_sig[3]=(TH1D*)input2->Get("fpcandstartz_sig_2");
  h_pstartz_sig[3]->Rebin(4);
  h_pstartz_sig[3]->Sumw2();
  h_pstartz_sig[4]=(TH1D*)input2->Get("fpcandstartz_sig_3");
  h_pstartz_sig[4]->Rebin(4);
  h_pstartz_sig[4]->Sumw2();
  ...
  h_pendx_sig[0]->Sumw2();
  h_pendx_sig[1]=(TH1D*)input2->Get("fpcandendx_sig_0");
  h_pendx_sig[1]->Rebin(4);
  h_pendx_sig[1]->Sumw2();
  h_pendx_sig[2]=(TH1D*)input2->Get("fpcandendx_sig_1");
  h_pendx_sig[2]->Rebin(4);
  h_pendx_sig[2]->Sumw2();
  h_pendx_sig[3]=(TH1D*)input2->Get("fpcandendx_sig_2");
  h_pendx_sig[3]->Rebin(4);
  h_pendx_sig[3]->Sumw2();
  h_pendx_sig[4]=(TH1D*)input2->Get("fpcandendx_sig_3");
  h_pendx_sig[4]->Rebin(4);
  h_pendx_sig[4]->Sumw2();
  ...
  h_pendy_sig[0]->Sumw2();
  h_pendy_sig[1]=(TH1D*)input2->Get("fpcandendy_sig_0");
  h_pendy_sig[1]->Rebin(4);
  h_pendy_sig[1]->Sumw2();
  h_pendy_sig[2]=(TH1D*)input2->Get("fpcandendy_sig_1");
  h_pendy_sig[2]->Rebin(4);
  h_pendy_sig[2]->Sumw2();
  h_pendy_sig[3]=(TH1D*)input2->Get("fpcandendy_sig_2");
  h_pendy_sig[3]->Rebin(4);
  h_pendy_sig[3]->Sumw2();
  h_pendy_sig[4]=(TH1D*)input2->Get("fpcandendy_sig_3");
  h_pendy_sig[4]->Rebin(4);
  h_pendy_sig[4]->Sumw2();
  ...
  h_pendz_sig[0]->Sumw2();
  h_pendz_sig[1]=(TH1D*)input2->Get("fpcandendz_sig_0");
  h_pendz_sig[1]->Rebin(4);
  h_pendz_sig[1]->Sumw2();
  h_pendz_sig[2]=(TH1D*)input2->Get("fpcandendz_sig_1");
  h_pendz_sig[2]->Rebin(4);
  h_pendz_sig[2]->Sumw2();
  h_pendz_sig[3]=(TH1D*)input2->Get("fpcandendz_sig_2");
  h_pendz_sig[3]->Rebin(4);
  h_pendz_sig[3]->Sumw2();
  h_pendz_sig[4]=(TH1D*)input2->Get("fpcandendz_sig_3");
  h_pendz_sig[4]->Rebin(4);
  h_pendz_sig[4]->Sumw2();
  ...
  if (tune==3){mcbnbcos_POT=4.0677e20;} // Tune3
...
//------------------------------------------------------------------
  ...
  h_range_sig[1]->SetFillColor(2); 
  h_range_sig[1]->Scale(normfac);
  h_range_sig[2]->SetFillColor(3); 
  h_range_sig[2]->Scale(normfac);
  h_range_sig[3]->SetFillColor(4); 
  h_range_sig[3]->Scale(normfac);
  h_range_sig[4]->SetFillColor(5); 
  h_range_sig[4]->Scale(normfac);
      
  h_range_bac[0]-> SetFillColor(6);
  h_range_bac[0]->SetLineColor(6);
  h_range_bac[0]->Scale(normfac);
  h_range_bac[1]-> SetFillColor(6);
  h_range_bac[1]->SetLineColor(6);
  h_range_bac[1]->Scale(normfac);
  h_range_bac[2]-> SetFillColor(6);
  h_range_bac[2]->SetLineColor(6);
  h_range_bac[2]->Scale(normfac);
  h_range_bac[3]-> SetFillColor(6);
  h_range_bac[3]->SetLineColor(6);
  h_range_bac[3]->Scale(normfac);
  h_range_bac[4]-> SetFillColor(6);
  h_range_bac[4]->SetLineColor(6);
  h_range_bac[4]->Scale(normfac);
  h_range_bac[5]-> SetFillColor(6);
  h_range_bac[5]->SetLineColor(6);
  h_range_bac[5]->Scale(normfac);
  h_range_bac[6]-> SetFillColor(6);
  h_range_bac[6]->SetLineColor(6);
  h_range_bac[6]->Scale(normfac);
  h_range_bac[7]-> SetFillColor(6);
  h_range_bac[7]->SetLineColor(6);
  ...
  h_range_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_range -> Add(h_range_sig[1]);
   hs_range -> Add(h_range_sig[2]);
   hs_range -> Add(h_range_sig[3]);
   hs_range -> Add(h_range_sig[4]);
  ...
  TLegend *legendL = new TLegend(.10, .65, .35, .90);
  ...
  legend -> AddEntry(h_range_sig[1], "1uNp (CCQE)", "f");
  legend -> AddEntry(h_range_sig[2], "1uNp (CCRES)", "f");
  legend -> AddEntry(h_range_sig[3], "1uNp (CCCoh)", "f");
  legend -> AddEntry(h_range_sig[4], "1uNp (CCMEC)", "f");

  legend -> AddEntry(h_range_bac[0], "Total-bac", "f");
  ...
  //legend->AddEntry(h_range_allsel[2],"MC");
  //legend -> AddEntry(h_range_sig[0], "1uNp (CC)", "f");
  legendL -> AddEntry(h_range_sig[1], "1uNp (CCQE)", "f");
  legendL -> AddEntry(h_range_sig[2], "1uNp (CCRES)", "f");
  legendL -> AddEntry(h_range_sig[3], "1uNp (CCCoh)", "f");
  legendL -> AddEntry(h_range_sig[4], "1uNp (CCMEC)", "f");

  legendL -> AddEntry(h_range_bac[0], "Total-bac", "f");
  ...
  if (tune==3){c1->Print("figures/Tune3/SigSep/h_range_allsel.png");}
  else{c1->Print("figures/Tune1/SigSep/h_range_allsel.png");}
 ...
 //==============================================================================
  ...
  h_trkmom_sig[1]-> SetFillColor(2); 
  h_trkmom_sig[1]->Scale(normfac);
  h_trkmom_sig[2]-> SetFillColor(3); 
  h_trkmom_sig[2]->Scale(normfac);
  h_trkmom_sig[3]-> SetFillColor(3); 
  h_trkmom_sig[3]->Scale(normfac);
  h_trkmom_sig[4]-> SetFillColor(5); 
  h_trkmom_sig[4]->Scale(normfac);




  h_trkmom_bac[0]-> SetFillColor(6);
  h_trkmom_bac[0]-> SetLineColor(6);
  h_trkmom_bac[0]->Scale(normfac);
  h_trkmom_bac[1]-> SetFillColor(6);
  h_trkmom_bac[1]-> SetLineColor(6);
  h_trkmom_bac[1]->Scale(normfac);
  h_trkmom_bac[2]-> SetFillColor(6);
  h_trkmom_bac[2]-> SetLineColor(6);
  h_trkmom_bac[2]->Scale(normfac);
  h_trkmom_bac[3]-> SetFillColor(6);
  h_trkmom_bac[3]-> SetLineColor(6);
  h_trkmom_bac[3]->Scale(normfac);
  h_trkmom_bac[4]-> SetFillColor(6);
  h_trkmom_bac[4]-> SetLineColor(6);
  h_trkmom_bac[4]->Scale(normfac);
  h_trkmom_bac[5]-> SetFillColor(6);
  h_trkmom_bac[5]-> SetLineColor(6);
  h_trkmom_bac[5]->Scale(normfac);
  h_trkmom_bac[6]-> SetFillColor(6);
  h_trkmom_bac[6]-> SetLineColor(6);
  h_trkmom_bac[6]->Scale(normfac);
  h_trkmom_bac[7]-> SetFillColor(6);
  h_trkmom_bac[7]-> SetLineColor(6);
  ...
  h_trkmom_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_trkmom -> Add(h_trkmom_sig[1]);
   hs_trkmom -> Add(h_trkmom_sig[2]);
   hs_trkmom -> Add(h_trkmom_sig[3]);
   hs_trkmom -> Add(h_trkmom_sig[4]);
  ...
  legend->Draw("same");
  if (tune==3){c1->Print("figures/Tune3/SigSep/h_trkmom_allsel.png");}
  else{c1->Print("figures/Tune1/SigSep/h_trkmom_allsel.png");}
  ...
  h_prange_allsel[0]->SetMaximum(1.6*h_prange_allsel[0]->GetMaximum());
  ...
  h_prange_sig[1]-> SetFillColor(2); 
  h_prange_sig[1]->Scale(normfac);
  h_prange_sig[2]-> SetFillColor(3); 
  h_prange_sig[2]->Scale(normfac);
  h_prange_sig[3]-> SetFillColor(4); 
  h_prange_sig[3]->Scale(normfac);
  h_prange_sig[4]-> SetFillColor(5); 
  h_prange_sig[4]->Scale(normfac);
      
  h_prange_bac[0]-> SetFillColor(6);
  h_prange_bac[0]-> SetLineColor(6);
  h_prange_bac[0]->Scale(normfac);
  h_prange_bac[1]-> SetFillColor(6);
  h_prange_bac[1]-> SetLineColor(6);
  h_prange_bac[1]->Scale(normfac);
  h_prange_bac[2]-> SetFillColor(6);
  h_prange_bac[2]-> SetLineColor(6);
  h_prange_bac[2]-> Scale(normfac);
  h_prange_bac[3]->SetFillColor(6);
  h_prange_bac[3]-> SetLineColor(6);
  h_prange_bac[3]->Scale(normfac);
  h_prange_bac[4]-> SetFillColor(6);
  h_prange_bac[4]-> SetLineColor(6);
  h_prange_bac[4]->Scale(normfac);
  h_prange_bac[5]-> SetFillColor(6);
  h_prange_bac[5]-> SetLineColor(6);
  h_prange_bac[5]->Scale(normfac);
  h_prange_bac[6]-> SetFillColor(6);
  h_prange_bac[6]-> SetLineColor(6);
  h_prange_bac[6]->Scale(normfac);
  h_prange_bac[7]-> SetFillColor(6);
  h_prange_bac[7]-> SetLineColor(6);
  ...
  h_prange_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_prange -> Add(h_prange_sig[1]);
   hs_prange -> Add(h_prange_sig[2]);
   hs_prange -> Add(h_prange_sig[3]);
   hs_prange -> Add(h_prange_sig[4]);
...
//  h_prange_zoom[2]->Draw("same");
  ...
  h_costheta_sig[1]-> SetFillColor(2); 
  h_costheta_sig[1]->Scale(normfac);
  h_costheta_sig[2]-> SetFillColor(3); 
  h_costheta_sig[2]->Scale(normfac);
  h_costheta_sig[3]-> SetFillColor(4); 
  h_costheta_sig[3]->Scale(normfac);
  h_costheta_sig[4]-> SetFillColor(5); 
  h_costheta_sig[4]->Scale(normfac);

  h_costheta_bac[0]-> SetFillColor(6);
  h_costheta_bac[0]-> SetLineColor(6);
  h_costheta_bac[0]->Scale(normfac);
  h_costheta_bac[1]-> SetFillColor(6);
  h_costheta_bac[1]-> SetLineColor(6);
  h_costheta_bac[1]->Scale(normfac);
  h_costheta_bac[2]-> SetFillColor(6);
  h_costheta_bac[2]-> SetLineColor(6);
  h_costheta_bac[2]->Scale(normfac);
  h_costheta_bac[3]-> SetFillColor(6);
  h_costheta_bac[3]-> SetLineColor(6);
  h_costheta_bac[3]->Scale(normfac);
  h_costheta_bac[4]-> SetFillColor(6);
  h_costheta_bac[4]-> SetLineColor(6);
  h_costheta_bac[4]->Scale(normfac);
  h_costheta_bac[5]-> SetFillColor(6);
  h_costheta_bac[5]-> SetLineColor(6);
  h_costheta_bac[5]->Scale(normfac);
  h_costheta_bac[6]-> SetFillColor(6);
  h_costheta_bac[6]-> SetLineColor(6);
  h_costheta_bac[6]->Scale(normfac);
  h_costheta_bac[7]-> SetFillColor(6);
  h_costheta_bac[7]-> SetLineColor(6);
  ...
  h_costheta_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_costheta -> Add(h_costheta_sig[1]);
   hs_costheta -> Add(h_costheta_sig[2]);
   hs_costheta -> Add(h_costheta_sig[3]);
   hs_costheta -> Add(h_costheta_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
  legendL->Draw("same");
  if (tune==3){c1->Print("figures/Tune3/SigSep/h_costheta_allsel.png");}
  else{c1->Print("figures/Tune1/SigSep/h_costheta_allsel.png");}
  ...
  h_pcostheta_sig[1]-> SetFillColor(2); 
  h_pcostheta_sig[1]->Scale(normfac);
  h_pcostheta_sig[2]-> SetFillColor(3); 
  h_pcostheta_sig[2]->Scale(normfac);
  h_pcostheta_sig[3]-> SetFillColor(4); 
  h_pcostheta_sig[3]->Scale(normfac);
  h_pcostheta_sig[4]-> SetFillColor(5); 
  h_pcostheta_sig[4]->Scale(normfac);

  h_pcostheta_bac[0]-> SetFillColor(6);
  h_pcostheta_bac[0]-> SetLineColor(6);
  h_pcostheta_bac[0]->Scale(normfac);
  h_pcostheta_bac[1]-> SetFillColor(6);
  h_pcostheta_bac[1]-> SetLineColor(6);
  h_pcostheta_bac[1]->Scale(normfac);
  h_pcostheta_bac[2]-> SetFillColor(6);
  h_pcostheta_bac[2]-> SetLineColor(6);
  h_pcostheta_bac[2]->Scale(normfac);
  h_pcostheta_bac[3]-> SetFillColor(6);
  h_pcostheta_bac[3]-> SetLineColor(6);
  h_pcostheta_bac[3]->Scale(normfac);
  h_pcostheta_bac[4]-> SetFillColor(6);
  h_pcostheta_bac[4]-> SetLineColor(6);
  h_pcostheta_bac[4]->Scale(normfac);
  h_pcostheta_bac[5]-> SetFillColor(6);
  h_pcostheta_bac[5]-> SetLineColor(6);
  h_pcostheta_bac[5]->Scale(normfac);
  h_pcostheta_bac[6]-> SetFillColor(6);
  h_pcostheta_bac[6]-> SetLineColor(6);
  h_pcostheta_bac[6]->Scale(normfac);
  h_pcostheta_bac[7]-> SetFillColor(6);
  h_pcostheta_bac[7]-> SetLineColor(6);
  ...
  h_pcostheta_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pcostheta -> Add(h_pcostheta_sig[1]);
   hs_pcostheta -> Add(h_pcostheta_sig[2]);
   hs_pcostheta -> Add(h_pcostheta_sig[3]);
   hs_pcostheta -> Add(h_pcostheta_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   legendL->Draw("same");
  if (tune==3){c1->Print("figures/Tune3/SigSep/h_pcostheta_allsel.png");}
  else{c1->Print("figures/Tune1/SigSep/h_pcostheta_allsel.png");}
  ...
  h_trunmean_muon_sig[1]-> SetFillColor(2); 
  h_trunmean_muon_sig[1]->Scale(normfac);
  h_trunmean_muon_sig[2]-> SetFillColor(3); 
  h_trunmean_muon_sig[2]->Scale(normfac);
  h_trunmean_muon_sig[3]-> SetFillColor(4); 
  h_trunmean_muon_sig[3]->Scale(normfac);
  h_trunmean_muon_sig[4]-> SetFillColor(5); 
  h_trunmean_muon_sig[4]->Scale(normfac);

  h_trunmean_muon_bac[0]-> SetFillColor(6);
  h_trunmean_muon_bac[0]-> SetLineColor(6);
  h_trunmean_muon_bac[0]->Scale(normfac);
  h_trunmean_muon_bac[1]-> SetFillColor(6);
  h_trunmean_muon_bac[1]-> SetLineColor(6);
  h_trunmean_muon_bac[1]->Scale(normfac);
  h_trunmean_muon_bac[2]-> SetFillColor(6);
  h_trunmean_muon_bac[2]-> SetLineColor(6);
  h_trunmean_muon_bac[2]->Scale(normfac);
  h_trunmean_muon_bac[3]-> SetFillColor(6);
  h_trunmean_muon_bac[3]-> SetLineColor(6);
  h_trunmean_muon_bac[3]->Scale(normfac);
  h_trunmean_muon_bac[4]-> SetFillColor(6);
  h_trunmean_muon_bac[4]-> SetLineColor(6);
  h_trunmean_muon_bac[4]->Scale(normfac);
  h_trunmean_muon_bac[5]-> SetFillColor(6);
  h_trunmean_muon_bac[5]-> SetLineColor(6);
  h_trunmean_muon_bac[5]->Scale(normfac);
  h_trunmean_muon_bac[6]-> SetFillColor(6);
  h_trunmean_muon_bac[6]-> SetLineColor(6);
  h_trunmean_muon_bac[6]->Scale(normfac);
  h_trunmean_muon_bac[7]-> SetFillColor(6);
  h_trunmean_muon_bac[7]-> SetLineColor(6);
  ...
  h_trunmean_muon_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_trunmean_muon -> Add(h_trunmean_muon_sig[1]);
   hs_trunmean_muon -> Add(h_trunmean_muon_sig[2]);
   hs_trunmean_muon -> Add(h_trunmean_muon_sig[3]);
   hs_trunmean_muon -> Add(h_trunmean_muon_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_trunmean_muon.png");}
   else{c1->Print("figures/Tune1/SigSep/h_trunmean_muon.png");}
  //==================================================================================
  ...
  h_trunmean_proton_sig[1]-> SetFillColor(2); 
  h_trunmean_proton_sig[1]->Scale(normfac);
  h_trunmean_proton_sig[2]-> SetFillColor(3); 
  h_trunmean_proton_sig[2]->Scale(normfac);
  h_trunmean_proton_sig[3]-> SetFillColor(4); 
  h_trunmean_proton_sig[3]->Scale(normfac);
  h_trunmean_proton_sig[4]-> SetFillColor(5); 
  h_trunmean_proton_sig[4]->Scale(normfac);

  h_trunmean_proton_bac[0]-> SetFillColor(6);
  h_trunmean_proton_bac[0]-> SetLineColor(6);
  h_trunmean_proton_bac[0]->Scale(normfac);
  h_trunmean_proton_bac[1]-> SetFillColor(6);
  h_trunmean_proton_bac[1]-> SetLineColor(6);
  h_trunmean_proton_bac[1]->Scale(normfac);
  h_trunmean_proton_bac[2]-> SetFillColor(6);
  h_trunmean_proton_bac[2]-> SetLineColor(6);
  h_trunmean_proton_bac[2]->Scale(normfac);
  h_trunmean_proton_bac[3]-> SetFillColor(6);
  h_trunmean_proton_bac[3]-> SetLineColor(6);
  h_trunmean_proton_bac[3]->Scale(normfac);
  h_trunmean_proton_bac[4]-> SetFillColor(6);
  h_trunmean_proton_bac[4]-> SetLineColor(6);
  h_trunmean_proton_bac[4]->Scale(normfac);
  h_trunmean_proton_bac[5]-> SetFillColor(6);
  h_trunmean_proton_bac[5]-> SetLineColor(6);
  h_trunmean_proton_bac[5]->Scale(normfac);
  h_trunmean_proton_bac[6]-> SetFillColor(6);
  h_trunmean_proton_bac[6]-> SetLineColor(6);
  h_trunmean_proton_bac[6]->Scale(normfac);
  h_trunmean_proton_bac[7]-> SetFillColor(6);
  h_trunmean_proton_bac[7]-> SetLineColor(6);
  ...
  h_trunmean_proton_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_trunmean_proton -> Add(h_trunmean_proton_sig[1]);
   hs_trunmean_proton -> Add(h_trunmean_proton_sig[2]);
   hs_trunmean_proton -> Add(h_trunmean_proton_sig[3]);
   hs_trunmean_proton -> Add(h_trunmean_proton_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_trunmean_proton.png");}
   else{c1->Print("figures/Tune1/SigSep/h_trunmean_proton.png");}
...
//===============================================
  ...
  h_phi_sig[1]-> SetFillColor(2); 
  h_phi_sig[1]->Scale(normfac);
  h_phi_sig[2]-> SetFillColor(3); 
  h_phi_sig[2]->Scale(normfac);
  h_phi_sig[3]-> SetFillColor(4); 
  h_phi_sig[3]->Scale(normfac);
  h_phi_sig[4]-> SetFillColor(5); 
  h_phi_sig[4]->Scale(normfac);
      
  h_phi_bac[0]-> SetFillColor(6);
  h_phi_bac[0]-> SetLineColor(6);
  h_phi_bac[0]->Scale(normfac);
  h_phi_bac[1]-> SetFillColor(6);
  h_phi_bac[1]-> SetLineColor(6);
  h_phi_bac[1]->Scale(normfac);
  h_phi_bac[2]-> SetFillColor(6);
  h_phi_bac[2]-> SetLineColor(6);
  h_phi_bac[2]->Scale(normfac);
  h_phi_bac[3]-> SetFillColor(6);
  h_phi_bac[3]-> SetLineColor(6);
  h_phi_bac[3]->Scale(normfac);
  h_phi_bac[4]-> SetFillColor(6);
  h_phi_bac[4]-> SetLineColor(6);
  h_phi_bac[4]->Scale(normfac);
  h_phi_bac[5]-> SetFillColor(6);
  h_phi_bac[5]-> SetLineColor(6);
  h_phi_bac[5]->Scale(normfac);
  h_phi_bac[6]-> SetFillColor(6);
  h_phi_bac[6]-> SetLineColor(6);
  h_phi_bac[6]->Scale(normfac);
  h_phi_bac[7]-> SetFillColor(6);
  h_phi_bac[7]-> SetLineColor(6);
  ...
  h_phi_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_phi -> Add(h_phi_sig[1]);
   hs_phi -> Add(h_phi_sig[2]);
   hs_phi -> Add(h_phi_sig[3]);
   hs_phi -> Add(h_phi_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_phi_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_phi_allsel.png");}
  ...
  h_pphi_sig[1]-> SetFillColor(2); 
  h_pphi_sig[1]->Scale(normfac);
  h_pphi_sig[2]-> SetFillColor(3); 
  h_pphi_sig[2]->Scale(normfac);
  h_pphi_sig[3]-> SetFillColor(4); 
  h_pphi_sig[3]->Scale(normfac);
  h_pphi_sig[4]-> SetFillColor(5); 
  h_pphi_sig[4]->Scale(normfac);
      

  h_pphi_bac[0]-> SetFillColor(6);
  h_pphi_bac[0]->Scale(normfac);
  h_pphi_bac[1]-> SetFillColor(6);
  h_pphi_bac[1]->Scale(normfac);
  h_pphi_bac[2]-> SetFillColor(6);
  h_pphi_bac[2]->Scale(normfac);
  h_pphi_bac[3]-> SetFillColor(6);
  h_pphi_bac[3]->Scale(normfac);
  h_pphi_bac[4]-> SetFillColor(6);
  h_pphi_bac[4]->Scale(normfac);
  h_pphi_bac[5]-> SetFillColor(6);
  h_pphi_bac[5]->Scale(normfac);
  h_pphi_bac[6]-> SetFillColor(6);
  h_pphi_bac[6]->Scale(normfac);
  h_pphi_bac[7]-> SetFillColor(6);
  ...
  h_pphi_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pphi -> Add(h_pphi_sig[1]);
   hs_pphi -> Add(h_pphi_sig[2]);
   hs_pphi -> Add(h_pphi_sig[3]);
   hs_pphi -> Add(h_pphi_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_pphi_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_pphi_allsel.png");}
 //================================================================================ 
  ...
  h_ntrksp_sig[1]-> SetFillColor(2); 
  h_ntrksp_sig[1]->Scale(normfac);
 
  h_ntrksp_sig[2]-> SetFillColor(3); 
  h_ntrksp_sig[2]->Scale(normfac);

  h_ntrksp_sig[3]-> SetFillColor(4); 
  h_ntrksp_sig[3]->Scale(normfac);
 
  h_ntrksp_sig[4]-> SetFillColor(5); 
  h_ntrksp_sig[4]->Scale(normfac);
 

  h_ntrksp_bac[0]-> SetFillColor(6);
  h_ntrksp_bac[0]-> SetLineColor(6);
  h_ntrksp_bac[0]->Scale(normfac);
  h_ntrksp_bac[1]-> SetFillColor(6);
  h_ntrksp_bac[1]-> SetLineColor(6);
  h_ntrksp_bac[1]->Scale(normfac);
  h_ntrksp_bac[2]-> SetFillColor(6);
  h_ntrksp_bac[2]-> SetLineColor(6);
  h_ntrksp_bac[2]->Scale(normfac);
  h_ntrksp_bac[3]-> SetFillColor(6);
  h_ntrksp_bac[3]-> SetLineColor(6);
  h_ntrksp_bac[3]->Scale(normfac);
  h_ntrksp_bac[4]-> SetFillColor(6);
  h_ntrksp_bac[4]-> SetLineColor(6);
  h_ntrksp_bac[4]->Scale(normfac);
  h_ntrksp_bac[5]-> SetFillColor(6);
  h_ntrksp_bac[5]-> SetLineColor(6);
  h_ntrksp_bac[5]->Scale(normfac);
  h_ntrksp_bac[6]-> SetFillColor(6);
  h_ntrksp_bac[6]-> SetLineColor(6);
  h_ntrksp_bac[6]->Scale(normfac);
  h_ntrksp_bac[7]-> SetFillColor(6);
  h_ntrksp_bac[7]-> SetLineColor(6);
  ...
  h_ntrksp_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_ntrksp -> Add(h_ntrksp_sig[1]);
   hs_ntrksp -> Add(h_ntrksp_sig[2]);
   hs_ntrksp -> Add(h_ntrksp_sig[3]);
   hs_ntrksp -> Add(h_ntrksp_sig[4]);
...
//===========================================================================
  ...
  h_plep_sig[1]-> SetFillColor(2); 
  h_plep_sig[1]->Scale(normfac);
 
  h_plep_sig[2]-> SetFillColor(3); 
  h_plep_sig[2]->Scale(normfac);

  h_plep_sig[3]-> SetFillColor(4); 
  h_plep_sig[3]->Scale(normfac);
 
  h_plep_sig[4]-> SetFillColor(5); 
  h_plep_sig[4]->Scale(normfac);
 
  h_plep_bac[0]-> SetFillColor(6);
  h_plep_bac[0]-> SetLineColor(6);
  h_plep_bac[0]->Scale(normfac);
  h_plep_bac[1]-> SetFillColor(6);
  h_plep_bac[1]-> SetLineColor(6);
  h_plep_bac[1]->Scale(normfac);
  h_plep_bac[2]-> SetFillColor(6);
  h_plep_bac[2]-> SetLineColor(6);
  h_plep_bac[2]->Scale(normfac);
  h_plep_bac[3]-> SetFillColor(6);
  h_plep_bac[3]-> SetLineColor(6);
  h_plep_bac[3]->Scale(normfac);
  h_plep_bac[4]-> SetFillColor(6);
  h_plep_bac[4]-> SetLineColor(6);
  h_plep_bac[4]->Scale(normfac);
  h_plep_bac[5]-> SetFillColor(6);
  h_plep_bac[5]-> SetLineColor(6);
  h_plep_bac[5]->Scale(normfac);
  h_plep_bac[6]-> SetFillColor(6);
  h_plep_bac[6]-> SetLineColor(6);
  h_plep_bac[6]->Scale(normfac);
  h_plep_bac[7]-> SetFillColor(6);
  h_plep_bac[7]-> SetLineColor(6);
  ...
  h_plep_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_plep -> Add(h_plep_sig[1]);
   hs_plep -> Add(h_plep_sig[2]);
   hs_plep -> Add(h_plep_sig[3]);
   hs_plep -> Add(h_plep_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_plep_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_plep_allsel.png");}
 //==============================================================
  ...
  h_phad_sig[1]-> SetFillColor(2); 
  h_phad_sig[1]->Scale(normfac);
  h_phad_sig[2]-> SetFillColor(3); 
  h_phad_sig[2]->Scale(normfac);
  h_phad_sig[3]-> SetFillColor(4); 
  h_phad_sig[3]->Scale(normfac);
  h_phad_sig[4]-> SetFillColor(5); 
  h_phad_sig[4]->Scale(normfac);
    

  h_phad_bac[0]-> SetFillColor(6);
  h_phad_bac[0]-> SetLineColor(6);
  h_phad_bac[0]->Scale(normfac);
  h_phad_bac[1]-> SetFillColor(6);
  h_phad_bac[1]-> SetLineColor(6);
  h_phad_bac[1]->Scale(normfac);
  h_phad_bac[2]-> SetFillColor(6);
  h_phad_bac[2]-> SetLineColor(6);
  h_phad_bac[2]->Scale(normfac);
  h_phad_bac[3]-> SetFillColor(6);
  h_phad_bac[3]-> SetLineColor(6);
  h_phad_bac[3]->Scale(normfac);
  h_phad_bac[4]-> SetFillColor(6);
  h_phad_bac[4]-> SetLineColor(6);
  h_phad_bac[4]->Scale(normfac);
  h_phad_bac[5]-> SetFillColor(6);
  h_phad_bac[5]-> SetLineColor(6);
  h_phad_bac[5]->Scale(normfac);
  h_phad_bac[6]-> SetFillColor(6);
  h_phad_bac[6]-> SetLineColor(6);
  h_phad_bac[6]->Scale(normfac);
  h_phad_bac[7]-> SetFillColor(6);
  h_phad_bac[7]-> SetLineColor(6);
  ...
  h_phad_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_phad -> Add(h_phad_sig[1]);
   hs_phad -> Add(h_phad_sig[2]);
   hs_phad -> Add(h_phad_sig[3]);
   hs_phad -> Add(h_phad_sig[4]);
...
//==============================================================
  ...
  h_thetamup_sig[1]-> SetFillColor(2); 
  h_thetamup_sig[1]->Scale(normfac);
  h_thetamup_sig[2]-> SetFillColor(3); 
  h_thetamup_sig[2]->Scale(normfac);
  h_thetamup_sig[3]-> SetFillColor(4); 
  h_thetamup_sig[3]->Scale(normfac);
  h_thetamup_sig[4]-> SetFillColor(5); 
  h_thetamup_sig[4]->Scale(normfac);

  h_thetamup_bac[0]-> SetFillColor(6);
  h_thetamup_bac[0]-> SetLineColor(6);
  h_thetamup_bac[0]->Scale(normfac);
  h_thetamup_bac[1]-> SetFillColor(6);
  h_thetamup_bac[1]-> SetLineColor(6);
  h_thetamup_bac[1]->Scale(normfac);
  h_thetamup_bac[2]-> SetFillColor(6);
  h_thetamup_bac[2]-> SetLineColor(6);
  h_thetamup_bac[2]->Scale(normfac);
  h_thetamup_bac[3]-> SetFillColor(6);
  h_thetamup_bac[3]-> SetLineColor(6);
  h_thetamup_bac[3]->Scale(normfac);
  h_thetamup_bac[4]-> SetFillColor(6);
  h_thetamup_bac[4]-> SetLineColor(6);
  h_thetamup_bac[4]->Scale(normfac);
  h_thetamup_bac[5]-> SetFillColor(6);
  h_thetamup_bac[5]-> SetLineColor(6);
  h_thetamup_bac[5]->Scale(normfac);
  h_thetamup_bac[6]-> SetFillColor(6);
  h_thetamup_bac[6]-> SetLineColor(6);
  h_thetamup_bac[6]->Scale(normfac);
  h_thetamup_bac[7]-> SetFillColor(6);
  h_thetamup_bac[7]-> SetLineColor(6);
  ...
  h_thetamup_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_thetamup -> Add(h_thetamup_sig[1]);
   hs_thetamup -> Add(h_thetamup_sig[2]);
   hs_thetamup -> Add(h_thetamup_sig[3]);
   hs_thetamup -> Add(h_thetamup_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_thetamup_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_thetamup_allsel.png");}
//==================================================================
  ...
  h_thetapp_sig[1]-> SetFillColor(2); 
  h_thetapp_sig[1]->Scale(normfac);
  h_thetapp_sig[2]-> SetFillColor(3); 
  h_thetapp_sig[2]->Scale(normfac);
  h_thetapp_sig[3]-> SetFillColor(4); 
  h_thetapp_sig[3]->Scale(normfac);
  h_thetapp_sig[4]-> SetFillColor(5); 
  h_thetapp_sig[4]->Scale(normfac);
    
  h_thetapp_bac[0]-> SetFillColor(6);
  h_thetapp_bac[0]-> SetLineColor(6);
  h_thetapp_bac[0]->Scale(normfac);
  h_thetapp_bac[1]-> SetFillColor(6);
  h_thetapp_bac[1]-> SetLineColor(6);
  h_thetapp_bac[1]->Scale(normfac);
  h_thetapp_bac[2]-> SetFillColor(6);
  h_thetapp_bac[2]-> SetLineColor(6);
  h_thetapp_bac[2]->Scale(normfac);
  h_thetapp_bac[3]-> SetFillColor(6);
  h_thetapp_bac[3]-> SetLineColor(6);
  h_thetapp_bac[3]->Scale(normfac);
  h_thetapp_bac[4]-> SetFillColor(6);
  h_thetapp_bac[4]-> SetLineColor(6);
  h_thetapp_bac[4]->Scale(normfac);
  h_thetapp_bac[5]-> SetFillColor(6);
  h_thetapp_bac[5]-> SetLineColor(6);
  h_thetapp_bac[5]->Scale(normfac);
  h_thetapp_bac[6]-> SetFillColor(6);
  h_thetapp_bac[6]-> SetLineColor(6);
  h_thetapp_bac[6]->Scale(normfac);
  h_thetapp_bac[7]-> SetFillColor(6);
  h_thetapp_bac[7]-> SetLineColor(6);
  ...
  h_thetapp_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_thetapp -> Add(h_thetapp_sig[1]);
   hs_thetapp -> Add(h_thetapp_sig[2]);
   hs_thetapp -> Add(h_thetapp_sig[3]);
   hs_thetapp -> Add(h_thetapp_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_thetapp_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_thetapp_allsel.png");}
...
//==================================================================
  ...
  h_phimup_sig[1]-> SetFillColor(2); 
  h_phimup_sig[1]->Scale(normfac);
  h_phimup_sig[2]-> SetFillColor(3); 
  h_phimup_sig[2]->Scale(normfac);
  h_phimup_sig[3]-> SetFillColor(4); 
  h_phimup_sig[3]->Scale(normfac);
  h_phimup_sig[4]-> SetFillColor(5); 
  h_phimup_sig[4]->Scale(normfac);
    
  h_phimup_bac[0]-> SetFillColor(6);
  h_phimup_bac[0]-> SetLineColor(6);
  h_phimup_bac[0]->Scale(normfac);
  h_phimup_bac[1]-> SetFillColor(6);
  h_phimup_bac[1]-> SetLineColor(6);
  h_phimup_bac[1]->Scale(normfac);
  h_phimup_bac[2]-> SetFillColor(6);
  h_phimup_bac[2]-> SetLineColor(6);
  h_phimup_bac[2]->Scale(normfac);
  h_phimup_bac[3]-> SetFillColor(6);
  h_phimup_bac[3]-> SetLineColor(6);
  h_phimup_bac[3]->Scale(normfac);
  h_phimup_bac[4]-> SetFillColor(6);
  h_phimup_bac[4]-> SetLineColor(6);
  h_phimup_bac[4]->Scale(normfac);
  h_phimup_bac[5]-> SetFillColor(6);
  h_phimup_bac[5]-> SetLineColor(6);
  h_phimup_bac[5]->Scale(normfac);
  h_phimup_bac[6]-> SetFillColor(6);
  h_phimup_bac[6]-> SetLineColor(6);
  h_phimup_bac[6]->Scale(normfac);
  h_phimup_bac[7]-> SetFillColor(6);
  h_phimup_bac[7]-> SetLineColor(6);
  ...
  h_phimup_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_phimup -> Add(h_phimup_sig[1]);
   hs_phimup -> Add(h_phimup_sig[2]);
   hs_phimup -> Add(h_phimup_sig[3]);
   hs_phimup -> Add(h_phimup_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_phimup_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_phimup_allsel.png");}
//================================================================
  ...
  h_phipp_sig[1]-> SetFillColor(2); 
  h_phipp_sig[1]->Scale(normfac);
  h_phipp_sig[2]-> SetFillColor(3); 
  h_phipp_sig[2]->Scale(normfac);
  h_phipp_sig[3]-> SetFillColor(4); 
  h_phipp_sig[3]->Scale(normfac);
  h_phipp_sig[4]-> SetFillColor(5); 
  h_phipp_sig[4]->Scale(normfac);

  h_phipp_bac[0]-> SetFillColor(6);
  h_phipp_bac[0]-> SetLineColor(6);
  h_phipp_bac[0]->Scale(normfac);
  h_phipp_bac[1]-> SetFillColor(6);
  h_phipp_bac[1]-> SetLineColor(6);
  h_phipp_bac[1]->Scale(normfac);
  h_phipp_bac[2]-> SetFillColor(6);
  h_phipp_bac[2]-> SetLineColor(6);
  h_phipp_bac[2]->Scale(normfac);
  h_phipp_bac[3]-> SetFillColor(6);
  h_phipp_bac[3]-> SetLineColor(6);
  h_phipp_bac[3]->Scale(normfac);
  h_phipp_bac[4]-> SetFillColor(6);
  h_phipp_bac[4]-> SetLineColor(6);
  h_phipp_bac[4]->Scale(normfac);
  h_phipp_bac[5]-> SetFillColor(6);
  h_phipp_bac[5]-> SetLineColor(6);
  h_phipp_bac[5]->Scale(normfac);
  h_phipp_bac[6]-> SetFillColor(6);
  h_phipp_bac[6]-> SetLineColor(6);
  h_phipp_bac[6]->Scale(normfac);
  h_phipp_bac[7]-> SetFillColor(6);
  h_phipp_bac[7]-> SetLineColor(6);
  ...
  h_phipp_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_phipp -> Add(h_phipp_sig[1]);
   hs_phipp -> Add(h_phipp_sig[2]);
   hs_phipp -> Add(h_phipp_sig[3]);
   hs_phipp -> Add(h_phipp_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_phipp_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_phipp_allsel.png");}
...
//--------------------------------------------------------------
  ...
  h_Nhitsmuon_sig[1]-> SetFillColor(2); 
  h_Nhitsmuon_sig[1]->Scale(normfac);
  h_Nhitsmuon_sig[2]-> SetFillColor(3); 
  h_Nhitsmuon_sig[2]->Scale(normfac);
  h_Nhitsmuon_sig[3]-> SetFillColor(4); 
  h_Nhitsmuon_sig[3]->Scale(normfac);
  h_Nhitsmuon_sig[4]-> SetFillColor(5); 
  h_Nhitsmuon_sig[4]->Scale(normfac);

  h_Nhitsmuon_bac[0]-> SetFillColor(6);
  h_Nhitsmuon_bac[0]-> SetLineColor(6);
  h_Nhitsmuon_bac[0]->Scale(normfac);
  h_Nhitsmuon_bac[1]-> SetFillColor(6);
  h_Nhitsmuon_bac[1]-> SetLineColor(6);
  h_Nhitsmuon_bac[1]->Scale(normfac);
  h_Nhitsmuon_bac[2]-> SetFillColor(6);
  h_Nhitsmuon_bac[2]-> SetLineColor(6);
  h_Nhitsmuon_bac[2]->Scale(normfac);
  h_Nhitsmuon_bac[3]-> SetFillColor(6);
  h_Nhitsmuon_bac[3]-> SetLineColor(6);
  h_Nhitsmuon_bac[3]->Scale(normfac);
  h_Nhitsmuon_bac[4]-> SetFillColor(6);
  h_Nhitsmuon_bac[4]-> SetLineColor(6);
  h_Nhitsmuon_bac[4]->Scale(normfac);
  h_Nhitsmuon_bac[5]-> SetFillColor(6);
  h_Nhitsmuon_bac[5]-> SetLineColor(6);
  h_Nhitsmuon_bac[5]->Scale(normfac);
  h_Nhitsmuon_bac[6]-> SetFillColor(6);
  h_Nhitsmuon_bac[6]-> SetLineColor(6);
  h_Nhitsmuon_bac[6]->Scale(normfac);
  h_Nhitsmuon_bac[7]-> SetFillColor(6);
  h_Nhitsmuon_bac[7]-> SetLineColor(6);
  ...
  h_Nhitsmuon_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_Nhitsmuon -> Add(h_Nhitsmuon_sig[1]);
   hs_Nhitsmuon -> Add(h_Nhitsmuon_sig[2]);
   hs_Nhitsmuon -> Add(h_Nhitsmuon_sig[3]);
   hs_Nhitsmuon -> Add(h_Nhitsmuon_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_Nhitsmuon_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_Nhitsmuon_allsel.png");}
...
//-----------------------------------------------------------
  ...
  h_Nhitsproton_sig[1]-> SetFillColor(2); 
  h_Nhitsproton_sig[1]->Scale(normfac);
  h_Nhitsproton_sig[2]-> SetFillColor(3); 
  h_Nhitsproton_sig[2]->Scale(normfac);
  h_Nhitsproton_sig[3]-> SetFillColor(4); 
  h_Nhitsproton_sig[3]->Scale(normfac);
  h_Nhitsproton_sig[4]-> SetFillColor(5); 
  h_Nhitsproton_sig[4]->Scale(normfac);

  h_Nhitsproton_bac[0]-> SetFillColor(6);
  h_Nhitsproton_bac[0]-> SetLineColor(6);
  h_Nhitsproton_bac[0]->Scale(normfac);
  h_Nhitsproton_bac[1]-> SetFillColor(6);
  h_Nhitsproton_bac[1]-> SetLineColor(6);
  h_Nhitsproton_bac[1]->Scale(normfac);
  h_Nhitsproton_bac[2]-> SetFillColor(6);
  h_Nhitsproton_bac[2]-> SetLineColor(6);
  h_Nhitsproton_bac[2]->Scale(normfac);
  h_Nhitsproton_bac[3]-> SetFillColor(6);
  h_Nhitsproton_bac[3]-> SetLineColor(6);
  h_Nhitsproton_bac[3]->Scale(normfac);
  h_Nhitsproton_bac[4]-> SetFillColor(6);
  h_Nhitsproton_bac[4]-> SetLineColor(6);
  h_Nhitsproton_bac[4]->Scale(normfac);
  h_Nhitsproton_bac[5]-> SetFillColor(6);
  h_Nhitsproton_bac[5]-> SetLineColor(6);
  h_Nhitsproton_bac[5]->Scale(normfac);
  h_Nhitsproton_bac[6]-> SetFillColor(6);
  h_Nhitsproton_bac[6]-> SetLineColor(6);
  h_Nhitsproton_bac[6]->Scale(normfac);
  h_Nhitsproton_bac[7]-> SetFillColor(6);
  h_Nhitsproton_bac[7]-> SetLineColor(6);
  ...
  h_Nhitsproton_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_Nhitsproton -> Add(h_Nhitsproton_sig[1]);
   hs_Nhitsproton -> Add(h_Nhitsproton_sig[2]);
   hs_Nhitsproton -> Add(h_Nhitsproton_sig[3]);
   hs_Nhitsproton -> Add(h_Nhitsproton_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if(tune==3){c1->Print("figures/Tune3/SigSep/h_Nhitsproton_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_Nhitsproton_allsel.png");}
   //=====================================================================
   ...
   h_vtxx_sig[1]-> SetFillColor(2); 
   h_vtxx_sig[1]->Scale(normfac);
   h_vtxx_sig[2]-> SetFillColor(3); 
   h_vtxx_sig[2]->Scale(normfac);
   h_vtxx_sig[3]-> SetFillColor(4); 
   h_vtxx_sig[3]->Scale(normfac);
   h_vtxx_sig[4]-> SetFillColor(5); 
   h_vtxx_sig[4]->Scale(normfac);

   h_vtxx_bac[0]-> SetFillColor(6);
   h_vtxx_bac[0]-> SetLineColor(6);
   h_vtxx_bac[0]->Scale(normfac);
   h_vtxx_bac[1]-> SetFillColor(6);
   h_vtxx_bac[1]-> SetLineColor(6);
   h_vtxx_bac[1]->Scale(normfac);
   h_vtxx_bac[2]-> SetFillColor(6);
   h_vtxx_bac[2]-> SetLineColor(6);
   h_vtxx_bac[2]->Scale(normfac);
   h_vtxx_bac[3]-> SetFillColor(6);
   h_vtxx_bac[3]-> SetLineColor(6);
   h_vtxx_bac[3]->Scale(normfac);
   h_vtxx_bac[4]-> SetFillColor(6);
   h_vtxx_bac[4]-> SetLineColor(6);
   h_vtxx_bac[4]->Scale(normfac);
   h_vtxx_bac[5]-> SetFillColor(6);
   h_vtxx_bac[5]-> SetLineColor(6);
   h_vtxx_bac[5]->Scale(normfac);
   h_vtxx_bac[6]-> SetFillColor(6);
   h_vtxx_bac[6]-> SetLineColor(6);
   h_vtxx_bac[6]->Scale(normfac);
   h_vtxx_bac[7]-> SetFillColor(6);
   h_vtxx_bac[7]-> SetLineColor(6);
  ...
  h_vtxx_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_vtxx -> Add(h_vtxx_sig[1]);
   hs_vtxx -> Add(h_vtxx_sig[2]);
   hs_vtxx -> Add(h_vtxx_sig[3]);
   hs_vtxx -> Add(h_vtxx_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_vtxx_allsel.png");
   //============================================================
   ...
   h_vtxy_sig[1]-> SetFillColor(2); 
   h_vtxy_sig[1]->Scale(normfac);
   h_vtxy_sig[2]-> SetFillColor(3); 
   h_vtxy_sig[2]->Scale(normfac);
   h_vtxy_sig[3]-> SetFillColor(4); 
   h_vtxy_sig[3]->Scale(normfac);
   h_vtxy_sig[4]-> SetFillColor(5); 
   h_vtxy_sig[4]->Scale(normfac);

   h_vtxy_bac[0]-> SetFillColor(6);
   h_vtxy_bac[0]-> SetLineColor(6);
   h_vtxy_bac[0]->Scale(normfac);
   h_vtxy_bac[1]-> SetFillColor(6);
   h_vtxy_bac[1]-> SetLineColor(6);
   h_vtxy_bac[1]->Scale(normfac);
   h_vtxy_bac[2]-> SetFillColor(6);
   h_vtxy_bac[2]-> SetLineColor(6);
   h_vtxy_bac[2]->Scale(normfac);
   h_vtxy_bac[3]-> SetFillColor(6);
   h_vtxy_bac[3]-> SetLineColor(6);
   h_vtxy_bac[3]->Scale(normfac);
   h_vtxy_bac[4]-> SetFillColor(6);
   h_vtxy_bac[4]-> SetLineColor(6);
   h_vtxy_bac[4]->Scale(normfac);
   h_vtxy_bac[5]-> SetFillColor(6);
   h_vtxy_bac[5]-> SetLineColor(6);
   h_vtxy_bac[5]->Scale(normfac);
   h_vtxy_bac[6]-> SetFillColor(6);
   h_vtxy_bac[6]-> SetLineColor(6);
   h_vtxy_bac[6]->Scale(normfac);
   h_vtxy_bac[7]-> SetFillColor(6);
   h_vtxy_bac[7]-> SetLineColor(6);
  ...
  h_vtxy_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_vtxy -> Add(h_vtxy_sig[1]);
   hs_vtxy -> Add(h_vtxy_sig[2]);
   hs_vtxy -> Add(h_vtxy_sig[3]);
   hs_vtxy -> Add(h_vtxy_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_vtxy_allsel.png");
   //================================================================================ 
   ...
   h_vtxz_sig[1]-> SetFillColor(2); 
   h_vtxz_sig[1]->Scale(normfac);
   h_vtxz_sig[2]-> SetFillColor(3); 
   h_vtxz_sig[2]->Scale(normfac);
   h_vtxz_sig[3]-> SetFillColor(4); 
   h_vtxz_sig[3]->Scale(normfac);
   h_vtxz_sig[4]-> SetFillColor(5); 
   h_vtxz_sig[4]->Scale(normfac);


   h_vtxz_bac[0]-> SetFillColor(6);
   h_vtxz_bac[0]-> SetLineColor(6);
   h_vtxz_bac[0]->Scale(normfac);
   h_vtxz_bac[1]-> SetFillColor(6);
   h_vtxz_bac[1]-> SetLineColor(6);
   h_vtxz_bac[1]->Scale(normfac);
   h_vtxz_bac[2]-> SetFillColor(6);
   h_vtxz_bac[2]-> SetLineColor(6);
   h_vtxz_bac[2]->Scale(normfac);
   h_vtxz_bac[3]-> SetFillColor(6);
   h_vtxz_bac[3]-> SetLineColor(6);
   h_vtxz_bac[3]->Scale(normfac);
   h_vtxz_bac[4]-> SetFillColor(6);
   h_vtxz_bac[4]-> SetLineColor(6);
   h_vtxz_bac[4]->Scale(normfac);
   h_vtxz_bac[5]-> SetFillColor(6);
   h_vtxz_bac[5]-> SetLineColor(6);
   h_vtxz_bac[5]->Scale(normfac);
   h_vtxz_bac[6]-> SetFillColor(6);
   h_vtxz_bac[6]-> SetLineColor(6);
   h_vtxz_bac[6]->Scale(normfac);
   h_vtxz_bac[7]-> SetFillColor(6);
   h_vtxz_bac[7]-> SetLineColor(6);
  ...
  h_vtxz_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_vtxz -> Add(h_vtxz_sig[1]);
   hs_vtxz -> Add(h_vtxz_sig[2]);
   hs_vtxz -> Add(h_vtxz_sig[3]);
   hs_vtxz -> Add(h_vtxz_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_vtxz_allsel.png");
   //==================================================    
   ...
   h_mustartx_sig[1]-> SetFillColor(2); 
   h_mustartx_sig[1]->Scale(normfac);
   h_mustartx_sig[2]-> SetFillColor(3); 
   h_mustartx_sig[2]->Scale(normfac);
   h_mustartx_sig[3]-> SetFillColor(4); 
   h_mustartx_sig[3]->Scale(normfac);
   h_mustartx_sig[4]-> SetFillColor(5); 
   h_mustartx_sig[4]->Scale(normfac);


   h_mustartx_bac[0]-> SetFillColor(6);
   h_mustartx_bac[0]-> SetLineColor(6);
   h_mustartx_bac[0]->Scale(normfac);
   h_mustartx_bac[1]-> SetFillColor(6);
   h_mustartx_bac[1]-> SetLineColor(6);
   h_mustartx_bac[1]->Scale(normfac);
   h_mustartx_bac[2]-> SetFillColor(6);
   h_mustartx_bac[2]-> SetLineColor(6);
   h_mustartx_bac[2]->Scale(normfac);
   h_mustartx_bac[3]-> SetFillColor(6);
   h_mustartx_bac[3]-> SetLineColor(6);
   h_mustartx_bac[3]->Scale(normfac);
   h_mustartx_bac[4]-> SetFillColor(6);
   h_mustartx_bac[4]-> SetLineColor(6);
   h_mustartx_bac[4]->Scale(normfac);
   h_mustartx_bac[5]-> SetFillColor(6);
   h_mustartx_bac[5]-> SetLineColor(6);
   h_mustartx_bac[5]->Scale(normfac);
   h_mustartx_bac[6]-> SetFillColor(6);
   h_mustartx_bac[6]-> SetLineColor(6);
   h_mustartx_bac[6]->Scale(normfac);
   h_mustartx_bac[7]-> SetFillColor(6);
   h_mustartx_bac[7]-> SetLineColor(6);
  ...
  h_mustartx_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_mustartx -> Add(h_mustartx_sig[1]);
   hs_mustartx -> Add(h_mustartx_sig[2]);
   hs_mustartx -> Add(h_mustartx_sig[3]);
   hs_mustartx -> Add(h_mustartx_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_mustartx_allsel.png");
   ...
   h_mustarty_sig[1]-> SetFillColor(2); 
   h_mustarty_sig[1]->Scale(normfac);
   h_mustarty_sig[2]-> SetFillColor(3); 
   h_mustarty_sig[2]->Scale(normfac);
   h_mustarty_sig[3]-> SetFillColor(4); 
   h_mustarty_sig[3]->Scale(normfac);
   h_mustarty_sig[4]-> SetFillColor(5); 
   h_mustarty_sig[4]->Scale(normfac);

   h_mustarty_bac[0]-> SetFillColor(6);
   h_mustarty_bac[0]-> SetLineColor(6);
   h_mustarty_bac[0]->Scale(normfac);
   h_mustarty_bac[1]-> SetFillColor(6);
   h_mustarty_bac[1]-> SetLineColor(6);
   h_mustarty_bac[1]->Scale(normfac);
   h_mustarty_bac[2]-> SetFillColor(6);
   h_mustarty_bac[2]-> SetLineColor(6);
   h_mustarty_bac[2]->Scale(normfac);
   h_mustarty_bac[3]-> SetFillColor(6);
   h_mustarty_bac[3]-> SetLineColor(6);
   h_mustarty_bac[3]->Scale(normfac);
   h_mustarty_bac[4]-> SetFillColor(6);
   h_mustarty_bac[4]-> SetLineColor(6);
   h_mustarty_bac[4]->Scale(normfac);
   h_mustarty_bac[5]-> SetFillColor(6);
   h_mustarty_bac[5]-> SetLineColor(6);
   h_mustarty_bac[5]->Scale(normfac);
   h_mustarty_bac[6]-> SetFillColor(6);
   h_mustarty_bac[6]-> SetLineColor(6);
   h_mustarty_bac[6]->Scale(normfac);
   h_mustarty_bac[7]-> SetFillColor(6);
   h_mustarty_bac[7]-> SetLineColor(6);
  ...
  h_mustarty_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_mustarty -> Add(h_mustarty_sig[1]);
   hs_mustarty -> Add(h_mustarty_sig[2]);
   hs_mustarty -> Add(h_mustarty_sig[3]);
   hs_mustarty -> Add(h_mustarty_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_mustarty_allsel.png");
  //==================================================================== 
   ...
   h_mustartz_sig[1]-> SetFillColor(2); 
   h_mustartz_sig[1]->Scale(normfac);
   h_mustartz_sig[2]-> SetFillColor(3); 
   h_mustartz_sig[2]->Scale(normfac);
   h_mustartz_sig[3]-> SetFillColor(4); 
   h_mustartz_sig[3]->Scale(normfac);
   h_mustartz_sig[4]-> SetFillColor(5); 
   h_mustartz_sig[4]->Scale(normfac);


   h_mustartz_bac[0]-> SetFillColor(6);
   h_mustartz_bac[0]-> SetLineColor(6);
   h_mustartz_bac[0]->Scale(normfac);
   h_mustartz_bac[1]-> SetFillColor(6);
   h_mustartz_bac[1]-> SetLineColor(6);
   h_mustartz_bac[1]->Scale(normfac);
   h_mustartz_bac[2]-> SetFillColor(6);
   h_mustartz_bac[2]-> SetLineColor(6);
   h_mustartz_bac[2]->Scale(normfac);
   h_mustartz_bac[3]-> SetFillColor(6);
   h_mustartz_bac[3]-> SetLineColor(6);
   h_mustartz_bac[3]->Scale(normfac);
   h_mustartz_bac[4]-> SetFillColor(6);
   h_mustartz_bac[4]-> SetLineColor(6);
   h_mustartz_bac[4]->Scale(normfac);
   h_mustartz_bac[5]-> SetFillColor(6);
   h_mustartz_bac[5]-> SetLineColor(6);
   h_mustartz_bac[5]->Scale(normfac);
   h_mustartz_bac[6]-> SetFillColor(6);
   h_mustartz_bac[6]-> SetLineColor(6);
   h_mustartz_bac[6]->Scale(normfac);
   h_mustartz_bac[7]-> SetFillColor(6);
   h_mustartz_bac[7]-> SetLineColor(6);
  ...
  h_mustartz_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_mustartz -> Add(h_mustartz_sig[1]);
   hs_mustartz -> Add(h_mustartz_sig[2]);
   hs_mustartz -> Add(h_mustartz_sig[3]);
   hs_mustartz -> Add(h_mustartz_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_mustartz_allsel.png");
  //================================================================= 
   ...
   h_muendx_sig[1]-> SetFillColor(2); 
   h_muendx_sig[1]->Scale(normfac);
   h_muendx_sig[2]-> SetFillColor(3); 
   h_muendx_sig[2]->Scale(normfac);
   h_muendx_sig[3]-> SetFillColor(4); 
   h_muendx_sig[3]->Scale(normfac);
   h_muendx_sig[4]-> SetFillColor(5); 
   h_muendx_sig[4]->Scale(normfac);

   h_muendx_bac[0]-> SetFillColor(6);
   h_muendx_bac[0]-> SetLineColor(6);
   h_muendx_bac[0]->Scale(normfac);
   h_muendx_bac[1]-> SetFillColor(6);
   h_muendx_bac[1]-> SetLineColor(6);
   h_muendx_bac[1]->Scale(normfac);
   h_muendx_bac[2]-> SetFillColor(6);
   h_muendx_bac[2]-> SetLineColor(6);
   h_muendx_bac[2]->Scale(normfac);
   h_muendx_bac[3]-> SetFillColor(6);
   h_muendx_bac[3]-> SetLineColor(6);
   h_muendx_bac[3]->Scale(normfac);
   h_muendx_bac[4]-> SetFillColor(6);
   h_muendx_bac[4]-> SetLineColor(6);
   h_muendx_bac[4]->Scale(normfac);
   h_muendx_bac[5]-> SetFillColor(6);
   h_muendx_bac[5]-> SetLineColor(6);
   h_muendx_bac[5]->Scale(normfac);
   h_muendx_bac[6]-> SetFillColor(6);
   h_muendx_bac[6]-> SetLineColor(6);
   h_muendx_bac[6]->Scale(normfac);
   h_muendx_bac[7]-> SetFillColor(6);
   h_muendx_bac[7]-> SetLineColor(6);
  ...
  h_muendx_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_muendx -> Add(h_muendx_sig[1]);
   hs_muendx -> Add(h_muendx_sig[2]);
   hs_muendx -> Add(h_muendx_sig[3]);
   hs_muendx -> Add(h_muendx_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_muendx_allsel.png");
   ...
   h_muendy_sig[1]-> SetFillColor(2); 
   h_muendy_sig[1]->Scale(normfac);
   h_muendy_sig[2]-> SetFillColor(3); 
   h_muendy_sig[2]->Scale(normfac);
   h_muendy_sig[3]-> SetFillColor(4); 
   h_muendy_sig[3]->Scale(normfac);
   h_muendy_sig[4]-> SetFillColor(5); 
   h_muendy_sig[4]->Scale(normfac);

   h_muendy_bac[0]-> SetFillColor(6);
   h_muendy_bac[0]-> SetLineColor(6);
   h_muendy_bac[0]->Scale(normfac);
   h_muendy_bac[1]-> SetFillColor(6);
   h_muendy_bac[1]-> SetLineColor(6);
   h_muendy_bac[1]->Scale(normfac);
   h_muendy_bac[2]-> SetFillColor(6);
   h_muendy_bac[2]-> SetLineColor(6);
   h_muendy_bac[2]->Scale(normfac);
   h_muendy_bac[3]-> SetFillColor(6);
   h_muendy_bac[3]-> SetLineColor(6);
   h_muendy_bac[3]->Scale(normfac);
   h_muendy_bac[4]-> SetFillColor(6);
   h_muendy_bac[4]-> SetLineColor(6);
   h_muendy_bac[4]->Scale(normfac);
   h_muendy_bac[5]-> SetFillColor(6);
   h_muendy_bac[5]-> SetLineColor(6);
   h_muendy_bac[5]->Scale(normfac);
   h_muendy_bac[6]-> SetFillColor(6);
   h_muendy_bac[6]-> SetLineColor(6);
   h_muendy_bac[6]->Scale(normfac);
   h_muendy_bac[7]-> SetFillColor(9);
   h_muendy_bac[7]-> SetLineColor(6);
  ...
  h_muendy_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_muendy -> Add(h_muendy_sig[1]);
   hs_muendy -> Add(h_muendy_sig[2]);
   hs_muendy -> Add(h_muendy_sig[3]);
   hs_muendy -> Add(h_muendy_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_muendy_allsel.png");
  //==================================================================== 
   ...
   h_muendz_sig[1]-> SetFillColor(2); 
   h_muendz_sig[1]->Scale(normfac);
   h_muendz_sig[2]-> SetFillColor(3); 
   h_muendz_sig[2]->Scale(normfac);
   h_muendz_sig[3]-> SetFillColor(4); 
   h_muendz_sig[3]->Scale(normfac);
   h_muendz_sig[4]-> SetFillColor(5); 
   h_muendz_sig[4]->Scale(normfac);

   h_muendz_bac[0]-> SetFillColor(6);
   h_muendz_bac[0]-> SetLineColor(6);
   h_muendz_bac[0]->Scale(normfac);
   h_muendz_bac[1]-> SetFillColor(6);
   h_muendz_bac[1]-> SetLineColor(6);
   h_muendz_bac[1]->Scale(normfac);
   h_muendz_bac[2]-> SetFillColor(6);
   h_muendz_bac[2]-> SetLineColor(6);
   h_muendz_bac[2]->Scale(normfac);
   h_muendz_bac[3]-> SetFillColor(6);
   h_muendz_bac[3]-> SetLineColor(6);
   h_muendz_bac[3]->Scale(normfac);
   h_muendz_bac[4]-> SetFillColor(6);
   h_muendz_bac[4]-> SetLineColor(6);
   h_muendz_bac[4]->Scale(normfac);
   h_muendz_bac[5]-> SetFillColor(6);
   h_muendz_bac[5]-> SetLineColor(6);
   h_muendz_bac[5]->Scale(normfac);
   h_muendz_bac[6]-> SetFillColor(6);
   h_muendz_bac[6]-> SetLineColor(6);
   h_muendz_bac[6]->Scale(normfac);
   h_muendz_bac[7]-> SetFillColor(6);
   h_muendz_bac[7]-> SetLineColor(6);
  ...
  h_muendz_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_muendz -> Add(h_muendz_sig[1]);
   hs_muendz -> Add(h_muendz_sig[2]);
   hs_muendz -> Add(h_muendz_sig[3]);
   hs_muendz -> Add(h_muendz_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_muendz_allsel.png");
   //==================================================================   
   ...
   h_pstartx_sig[1]-> SetFillColor(2); 
   h_pstartx_sig[1]->Scale(normfac);
   h_pstartx_sig[2]-> SetFillColor(3); 
   h_pstartx_sig[2]->Scale(normfac);
   h_pstartx_sig[3]-> SetFillColor(4); 
   h_pstartx_sig[3]->Scale(normfac);
   h_pstartx_sig[4]-> SetFillColor(5); 
   h_pstartx_sig[4]->Scale(normfac);

   h_pstartx_bac[0]-> SetFillColor(6);
   h_pstartx_bac[0]-> SetLineColor(6);
   h_pstartx_bac[0]->Scale(normfac);
   h_pstartx_bac[1]-> SetFillColor(6);
   h_pstartx_bac[1]-> SetLineColor(6);
   h_pstartx_bac[1]->Scale(normfac);
   h_pstartx_bac[2]-> SetFillColor(6);
   h_pstartx_bac[2]-> SetLineColor(6);
   h_pstartx_bac[2]->Scale(normfac);
   h_pstartx_bac[3]-> SetFillColor(6);
   h_pstartx_bac[3]-> SetLineColor(6);
   h_pstartx_bac[3]->Scale(normfac);
   h_pstartx_bac[4]-> SetFillColor(6);
   h_pstartx_bac[4]-> SetLineColor(6);
   h_pstartx_bac[4]->Scale(normfac);
   h_pstartx_bac[5]-> SetFillColor(6);
   h_pstartx_bac[5]-> SetLineColor(6);
   h_pstartx_bac[5]->Scale(normfac);
   h_pstartx_bac[6]-> SetFillColor(6);
   h_pstartx_bac[6]-> SetLineColor(6);
   h_pstartx_bac[6]->Scale(normfac);
   h_pstartx_bac[7]-> SetFillColor(6);
   h_pstartx_bac[7]-> SetLineColor(6);
  ...
  h_pstartx_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pstartx -> Add(h_pstartx_sig[1]);
   hs_pstartx -> Add(h_pstartx_sig[2]);
   hs_pstartx -> Add(h_pstartx_sig[3]);
   hs_pstartx -> Add(h_pstartx_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_pstartx_allsel.png");
   ...
   h_pstarty_sig[1]-> SetFillColor(2); 
   h_pstarty_sig[1]->Scale(normfac);
   h_pstarty_sig[2]-> SetFillColor(3); 
   h_pstarty_sig[2]->Scale(normfac);
   h_pstarty_sig[3]-> SetFillColor(4); 
   h_pstarty_sig[3]->Scale(normfac);
   h_pstarty_sig[4]-> SetFillColor(5); 
   h_pstarty_sig[4]->Scale(normfac);


   h_pstarty_bac[0]-> SetFillColor(6);
   h_pstarty_bac[0]-> SetLineColor(6);
   h_pstarty_bac[0]->Scale(normfac);
   h_pstarty_bac[1]-> SetFillColor(6);
   h_pstarty_bac[1]-> SetLineColor(6);
   h_pstarty_bac[1]->Scale(normfac);
   h_pstarty_bac[2]-> SetFillColor(6);
   h_pstarty_bac[2]-> SetLineColor(6);
   h_pstarty_bac[2]->Scale(normfac);
   h_pstarty_bac[3]-> SetFillColor(6);
   h_pstarty_bac[3]-> SetLineColor(6);
   h_pstarty_bac[3]->Scale(normfac);
   h_pstarty_bac[4]-> SetFillColor(6);
   h_pstarty_bac[4]-> SetLineColor(6);
   h_pstarty_bac[4]->Scale(normfac);
   h_pstarty_bac[5]-> SetFillColor(6);
   h_pstarty_bac[5]-> SetLineColor(6);
   h_pstarty_bac[5]->Scale(normfac);
   h_pstarty_bac[6]-> SetFillColor(6);
   h_pstarty_bac[6]-> SetLineColor(6);
   h_pstarty_bac[6]->Scale(normfac);
   h_pstarty_bac[7]-> SetFillColor(6);
   h_pstarty_bac[7]-> SetLineColor(6);
  ...
  h_pstarty_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pstarty -> Add(h_pstarty_sig[1]);
   hs_pstarty -> Add(h_pstarty_sig[2]);
   hs_pstarty -> Add(h_pstarty_sig[3]);
   hs_pstarty -> Add(h_pstarty_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_pstarty_allsel.png");
  //==================================================================== 
   ...
   h_pstartz_sig[1]-> SetFillColor(2); 
   h_pstartz_sig[1]->Scale(normfac);
   h_pstartz_sig[2]-> SetFillColor(3); 
   h_pstartz_sig[2]->Scale(normfac);
   h_pstartz_sig[3]-> SetFillColor(4); 
   h_pstartz_sig[3]->Scale(normfac);
   h_pstartz_sig[4]-> SetFillColor(5); 
   h_pstartz_sig[4]->Scale(normfac);

   h_pstartz_bac[0]-> SetFillColor(6);
   h_pstartz_bac[0]-> SetLineColor(6);
   h_pstartz_bac[0]->Scale(normfac);
   h_pstartz_bac[1]-> SetFillColor(6);
   h_pstartz_bac[1]-> SetLineColor(6);
   h_pstartz_bac[1]->Scale(normfac);
   h_pstartz_bac[2]-> SetFillColor(6);
   h_pstartz_bac[2]-> SetLineColor(6);
   h_pstartz_bac[2]->Scale(normfac);
   h_pstartz_bac[3]-> SetFillColor(6);
   h_pstartz_bac[3]-> SetLineColor(6);
   h_pstartz_bac[3]->Scale(normfac);
   h_pstartz_bac[4]-> SetFillColor(6);
   h_pstartz_bac[4]-> SetLineColor(6);
   h_pstartz_bac[4]->Scale(normfac);
   h_pstartz_bac[5]-> SetFillColor(6);
   h_pstartz_bac[5]-> SetLineColor(6);
   h_pstartz_bac[5]->Scale(normfac);
   h_pstartz_bac[6]-> SetFillColor(6);
   h_pstartz_bac[6]-> SetLineColor(6);
   h_pstartz_bac[6]->Scale(normfac);
   h_pstartz_bac[7]-> SetFillColor(6);
   h_pstartz_bac[7]-> SetLineColor(6);
  ...
  h_pstartz_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pstartz -> Add(h_pstartz_sig[1]);
   hs_pstartz -> Add(h_pstartz_sig[2]);
   hs_pstartz -> Add(h_pstartz_sig[3]);
   hs_pstartz -> Add(h_pstartz_sig[4]);
...
//h_onoff_pstartz->Draw("E1CSAME");
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_pstartz_allsel.png");
  //================================================================= 
   ...
   h_pendx_sig[1]-> SetFillColor(2); 
   h_pendx_sig[1]->Scale(normfac);
   h_pendx_sig[2]-> SetFillColor(3); 
   h_pendx_sig[2]->Scale(normfac);
   h_pendx_sig[3]-> SetFillColor(4); 
   h_pendx_sig[3]->Scale(normfac);
   h_pendx_sig[4]-> SetFillColor(5); 
   h_pendx_sig[4]->Scale(normfac);


   h_pendx_bac[0]-> SetFillColor(6);
   h_pendx_bac[0]-> SetLineColor(6);
   h_pendx_bac[0]->Scale(normfac);
   h_pendx_bac[1]-> SetFillColor(6);
   h_pendx_bac[1]-> SetLineColor(6);
   h_pendx_bac[1]->Scale(normfac);
   h_pendx_bac[2]-> SetFillColor(6);
   h_pendx_bac[2]-> SetLineColor(6);
   h_pendx_bac[2]->Scale(normfac);
   h_pendx_bac[3]-> SetFillColor(6);
   h_pendx_bac[3]-> SetLineColor(6);
   h_pendx_bac[3]->Scale(normfac);
   h_pendx_bac[4]-> SetFillColor(6);
   h_pendx_bac[4]-> SetLineColor(6);
   h_pendx_bac[4]->Scale(normfac);
   h_pendx_bac[5]-> SetFillColor(6);
   h_pendx_bac[5]-> SetLineColor(6);
   h_pendx_bac[5]->Scale(normfac);
   h_pendx_bac[6]-> SetFillColor(6);
   h_pendx_bac[6]-> SetLineColor(6);
   h_pendx_bac[6]->Scale(normfac);
   h_pendx_bac[7]-> SetFillColor(6);
   h_pendx_bac[7]-> SetLineColor(6);
  ...
  h_pendx_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pendx -> Add(h_pendx_sig[1]);
   hs_pendx -> Add(h_pendx_sig[2]);
   hs_pendx -> Add(h_pendx_sig[3]);
   hs_pendx -> Add(h_pendx_sig[4]);
...
//h_onoff_pendx->Draw("E1CSAME");
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_pendx_allsel.png");
   ...
   h_pendy_sig[1]-> SetFillColor(2); 
   h_pendy_sig[1]->Scale(normfac);
   h_pendy_sig[2]-> SetFillColor(3); 
   h_pendy_sig[2]->Scale(normfac);
   h_pendy_sig[3]-> SetFillColor(4); 
   h_pendy_sig[3]->Scale(normfac);
   h_pendy_sig[4]-> SetFillColor(5); 
   h_pendy_sig[4]->Scale(normfac);


   h_pendy_bac[0]-> SetFillColor(6);
   h_pendy_bac[0]-> SetLineColor(6);
   h_pendy_bac[0]->Scale(normfac);
   h_pendy_bac[1]-> SetFillColor(6);
   h_pendy_bac[1]-> SetLineColor(6);
   h_pendy_bac[1]->Scale(normfac);
   h_pendy_bac[2]-> SetFillColor(6);
   h_pendy_bac[2]-> SetLineColor(6);
   h_pendy_bac[2]->Scale(normfac);
   h_pendy_bac[3]-> SetFillColor(6);
   h_pendy_bac[3]-> SetLineColor(6);
   h_pendy_bac[3]->Scale(normfac);
   h_pendy_bac[4]-> SetFillColor(6);
   h_pendy_bac[4]-> SetLineColor(6);
   h_pendy_bac[4]->Scale(normfac);
   h_pendy_bac[5]-> SetFillColor(6);
   h_pendy_bac[5]-> SetLineColor(6);
   h_pendy_bac[5]->Scale(normfac);
   h_pendy_bac[6]-> SetFillColor(6);
   h_pendy_bac[6]-> SetLineColor(6);
   h_pendy_bac[6]->Scale(normfac);
   h_pendy_bac[7]-> SetFillColor(6);
   h_pendy_bac[7]-> SetLineColor(6);
  ...
  h_pendy_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pendy -> Add(h_pendy_sig[1]);
   hs_pendy -> Add(h_pendy_sig[2]);
   hs_pendy -> Add(h_pendy_sig[3]);
   hs_pendy -> Add(h_pendy_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_pendy_allsel.png");
  //==================================================================== 
   ...
   h_pendz_sig[1]-> SetFillColor(2); 
   h_pendz_sig[1]->Scale(normfac);
   h_pendz_sig[2]-> SetFillColor(3); 
   h_pendz_sig[2]->Scale(normfac);
   h_pendz_sig[3]-> SetFillColor(4); 
   h_pendz_sig[3]->Scale(normfac);
   h_pendz_sig[4]-> SetFillColor(5); 
   h_pendz_sig[4]->Scale(normfac);

   h_pendz_bac[0]-> SetFillColor(6);
   h_pendz_bac[0]-> SetLineColor(6);
   h_pendz_bac[0]->Scale(normfac);
   h_pendz_bac[1]-> SetFillColor(6);
   h_pendz_bac[1]-> SetLineColor(6);
   h_pendz_bac[1]->Scale(normfac);
   h_pendz_bac[2]-> SetFillColor(6);
   h_pendz_bac[2]-> SetLineColor(6);
   h_pendz_bac[2]->Scale(normfac);
   h_pendz_bac[3]-> SetFillColor(6);
   h_pendz_bac[3]-> SetLineColor(6);
   h_pendz_bac[3]->Scale(normfac);
   h_pendz_bac[4]-> SetFillColor(6);
   h_pendz_bac[4]-> SetLineColor(6);
   h_pendz_bac[4]->Scale(normfac);
   h_pendz_bac[5]-> SetFillColor(6);
   h_pendz_bac[5]-> SetLineColor(6);
   h_pendz_bac[5]->Scale(normfac);
   h_pendz_bac[6]-> SetFillColor(6);
   h_pendz_bac[6]-> SetLineColor(6);
   h_pendz_bac[6]->Scale(normfac);
   h_pendz_bac[7]-> SetFillColor(6);
   h_pendz_bac[7]-> SetLineColor(6);
  ...
  h_pendz_allsel[1]->Scale(scale_onoffbeam);
   ...
   hs_pendz -> Add(h_pendz_sig[1]);
   hs_pendz -> Add(h_pendz_sig[2]);
   hs_pendz -> Add(h_pendz_sig[3]);
   hs_pendz -> Add(h_pendz_sig[4]);
...
//h_onoff_pendz->Draw("E1CSAME");
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   c1->Print("figures/Tune3/SigSep/h_pendz_allsel.png");
  //==================================================
   ...
   h_Evis_sig[1]-> SetFillColor(2); 
   h_Evis_sig[1]->Scale(normfac);

   h_Evis_sig[2]-> SetFillColor(3); 
   h_Evis_sig[2]->Scale(normfac);

   h_Evis_sig[3]-> SetFillColor(4); 
   h_Evis_sig[3]->Scale(normfac);

   h_Evis_sig[4]-> SetFillColor(5); 
   h_Evis_sig[4]->Scale(normfac);


   h_Evis_bac[0]-> SetFillColor(6);
   h_Evis_bac[0]-> SetLineColor(6);
   h_Evis_bac[0]->Scale(normfac);
   h_Evis_bac[1]-> SetFillColor(6);
   h_Evis_bac[1]-> SetLineColor(6);
   h_Evis_bac[1]->Scale(normfac);
   h_Evis_bac[2]-> SetFillColor(6);
   h_Evis_bac[2]-> SetLineColor(6);
   h_Evis_bac[2]->Scale(normfac);
   h_Evis_bac[3]-> SetFillColor(6);
   h_Evis_bac[3]-> SetLineColor(6);
   h_Evis_bac[3]->Scale(normfac);
   h_Evis_bac[4]-> SetFillColor(6);
   h_Evis_bac[4]-> SetLineColor(6);
   h_Evis_bac[4]->Scale(normfac);
   h_Evis_bac[5]-> SetFillColor(6);
   h_Evis_bac[5]-> SetLineColor(6);
   h_Evis_bac[5]->Scale(normfac);
   h_Evis_bac[6]-> SetFillColor(6);
   h_Evis_bac[6]-> SetLineColor(6);
   h_Evis_bac[6]->Scale(normfac);
   h_Evis_bac[7]-> SetFillColor(6);
   h_Evis_bac[7]-> SetLineColor(6);
   ...
   hs_Evis -> Add(h_Evis_sig[1]);
   hs_Evis -> Add(h_Evis_sig[2]);
   hs_Evis -> Add(h_Evis_sig[3]);
   hs_Evis -> Add(h_Evis_sig[4]);
...
//h_onoff_Evis->Draw("E1CSAME");
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_Evis_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_Evis_allsel.png");}
  //============================================================
   ...
   h_Q2cal_sig[1]-> SetFillColor(2); 
   h_Q2cal_sig[1]->Scale(normfac);
   h_Q2cal_sig[2]-> SetFillColor(3); 
   h_Q2cal_sig[2]->Scale(normfac);
   h_Q2cal_sig[3]-> SetFillColor(4); 
   h_Q2cal_sig[3]->Scale(normfac);
   h_Q2cal_sig[4]-> SetFillColor(5); 
   h_Q2cal_sig[4]->Scale(normfac);

   h_Q2cal_bac[0]-> SetFillColor(6);
   h_Q2cal_bac[0]-> SetLineColor(6);
   h_Q2cal_bac[0]->Scale(normfac);
   h_Q2cal_bac[1]-> SetFillColor(6);
   h_Q2cal_bac[1]-> SetLineColor(6);
   h_Q2cal_bac[1]->Scale(normfac);
   h_Q2cal_bac[2]-> SetFillColor(6);
   h_Q2cal_bac[2]-> SetLineColor(6);
   h_Q2cal_bac[2]->Scale(normfac);
   h_Q2cal_bac[3]-> SetFillColor(6);
   h_Q2cal_bac[3]-> SetLineColor(6);
   h_Q2cal_bac[3]->Scale(normfac);
   h_Q2cal_bac[4]-> SetFillColor(6);
   h_Q2cal_bac[4]-> SetLineColor(6);
   h_Q2cal_bac[4]->Scale(normfac);
   h_Q2cal_bac[5]-> SetFillColor(6);
   h_Q2cal_bac[5]-> SetLineColor(6);
   h_Q2cal_bac[5]->Scale(normfac);
   h_Q2cal_bac[6]-> SetFillColor(6);
   h_Q2cal_bac[6]-> SetLineColor(6);
   h_Q2cal_bac[6]->Scale(normfac);
   h_Q2cal_bac[7]-> SetFillColor(6);
   h_Q2cal_bac[7]-> SetLineColor(6);
   ...
   hs_Q2cal -> Add(h_Q2cal_sig[1]);
   hs_Q2cal -> Add(h_Q2cal_sig[2]);
   hs_Q2cal -> Add(h_Q2cal_sig[3]);
   hs_Q2cal -> Add(h_Q2cal_sig[4]);
  ...
  //~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~
   ...
   legend->Draw("same");
   if (tune==3){c1->Print("figures/Tune3/SigSep/h_Q2cal_allsel.png");}
   else{c1->Print("figures/Tune1/SigSep/h_Q2cal_allsel.png");}
