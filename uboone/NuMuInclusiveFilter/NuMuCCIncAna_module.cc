...
#ifndef  NuMuCCIncAna_Module
#define  NuMuCCIncAna_Module
...
namespace  NuMuCCIncAna
{
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
// class definition

class  NuMuCCIncAna : public art::EDAnalyzer
{
public:
 
    // Standard constructor and destructor for an ART module.
    explicit  NuMuCCIncAna(fhicl::ParameterSet const& pset);
    virtual ~ NuMuCCIncAna();
...
//-----------------------------------------------------------------------
// Constructor
 NuMuCCIncAna:: NuMuCCIncAna(fhicl::ParameterSet const& parameterSet)
...
//-----------------------------------------------------------------------
// Destructor
 NuMuCCIncAna::~ NuMuCCIncAna()
{}
   
//-----------------------------------------------------------------------
void  NuMuCCIncAna::beginJob()
{
...
//-----------------------------------------------------------------------
void  NuMuCCIncAna::beginRun(const art::Run& /*run*/)
{
}

//-----------------------------------------------------------------------
void  NuMuCCIncAna::reconfigure(fhicl::ParameterSet const& pset)
{
    ...
    {
        mf::LogError("NuMuCCIncFilter") << "Mismatch between string vector lengths input from fhicl!" << std::endl;
    }
...
void NuMuCCIncAna::respondToOpenInputFile(art::FileBlock const& fileBlock)
{
...
void NuMuCCIncAna::respontToOpenOutputFile(art::FileBlock const& fileBlock)
{
    // TODO
    return;
}
...
//-----------------------------------------------------------------------
void  NuMuCCIncAna::analyze(const art::Event& event)
{
...
DEFINE_ART_MODULE( NuMuCCIncAna)

} // namespace  NuMuCCIncAna

#endif //  NuMuCCIncAna_Module
