...
#include "TH1D.h"
//--------------------------------------------
#include "TrackPlusVertexAlg.h"
//--------------------------------------------
namespace NuMuCCIncFilter
{
...
public:
    ...
    explicit NuMuCCIncFilter(fhicl::ParameterSet const&);
    virtual ~NuMuCCIncFilter();
...
NuMuCCIncFilter::~NuMuCCIncFilter()
{
}
    
void NuMuCCIncFilter::beginJob()
{
...
void NuMuCCIncFilter::endJob()
{
    
}

void NuMuCCIncFilter::beginRun(const art::Run& run)
{
...
} // microboone::NuMuCCIncFilter::filter()
