/** 
 * oh god there are so many bad pieces of coding going in in this commit.
 *
 * There was some library issue with importing the truncated mean class defined in
 * larana so I took the easy way out and just copied it here for use with yet 
 * another badly written script. Sorry!
 */ 
