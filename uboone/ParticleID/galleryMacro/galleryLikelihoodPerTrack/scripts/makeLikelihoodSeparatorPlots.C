void makeLikelihoodSeparatorPlots(){
/*
  TCanvas *c1 = new TCanvas("c1", "c1", 500, 500);
  c1->cd();

  TH2D* h1 = (TH2D*)_file0->Get("hTrueMuonLikelihoodProtonLikelihoodMuon");
  TH2D* h2 = (TH2D*)_file0->Get("hTrueProtonLikelihoodProtonLikelihoodMuon");
  ...
  c1->SaveAs("Likelihood2Dplot.png");
*/
  TCanvas *c2 = new TCanvas("c2", "c2", 500, 500);
  c2->cd();

  TH1D* h3 = (TH1D*)_file0->Get("hTrueProtonMuonLikelihoodRatio");
  ...
  TH1D* h4 = (TH1D*)_file0->Get("hTrueMuonMuonLikelihoodRatio");
  ...
  TH2D* h5 = (TH2D*)_file0->Get("hTrueMuonMuonLikelihoodRatioRecoLength");
  TH2D* h6 = (TH2D*)_file0->Get("hTrueProtonMuonLikelihoodRatioRecoLength");
