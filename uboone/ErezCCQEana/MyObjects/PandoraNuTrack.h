...
public:
    ...
    //void  SetPandoraNuNewCaliPID (int plane, TFile *dEdxrr);
    void  SetPandoraNuNewCaliPID(int plane, TProfile *dedx_range_pro, TProfile *dedx_range_ka, TProfile *dedx_range_pi, TProfile *dedx_range_mu);
    ...
    Float_t         GetNewCaliPID_Chi2Proton ( Int_t plane )   const { return PandoraNuCaliPID_NewChi2Proton[plane];};
    Float_t           GetNewCaliPID_Chi2Muon ( Int_t plane )   const { return PandoraNuCaliPID_NewChi2Muon[plane];};
...
private:
    ...
    Float_t     PandoraNuCaliPID_NewChi2Proton[3]={-9999,-9999,-9999};
    ...
    Float_t     PandoraNuCaliPID_NewChi2Muon[3]={-9999,-9999,-9999};
