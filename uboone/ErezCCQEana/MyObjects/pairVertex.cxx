...
vector<size_t> pairVertex::sort_chi2proton(const vector<PandoraNuTrack> &v) {
    ...
    std::sort(idx.begin(), idx.end(), [&v](size_t i1, size_t i2) {return v[i1].GetNewCaliPID_Chi2Proton(2) > v[i2].GetNewCaliPID_Chi2Proton(2);});
...
bool pairVertex::SortTracksByChi2Proton(){
    ...
    if (tracks_chi2protonsorted.at( tmp_tracks.size() - 1 ).GetCaliPID_Chi2Proton(2) > tracks_chi2protonsorted.at( 0 ).GetCaliPID_Chi2Proton(2)) std::cout<<"inside SortTracksByChi2Proton stop!"<<std::endl;
    if (tracks_chi2protonsorted.at( tmp_tracks.size() - 1 ).GetNewCaliPID_Chi2Proton(2) > tracks_chi2protonsorted.at( 0 ).GetNewCaliPID_Chi2Proton(2)) std::cout<<"inside SortTracksByChi2Proton stop!sorting didn't work"<<std::endl;
